...
public class Description implements Serializable {
    ...
    public static final Pattern METHOD_AND_CLASS_NAME_PATTERN = Pattern.compile("([\\s\\S]*)\\((.*)\\)");
    public static final Description TEST_MECHANISM = new Description((Class<?>) null, "Test mechanism", new Annotation[0]);
    public static final long serialVersionUID = 1;
    public final Annotation[] fAnnotations;
    public final Collection<Description> fChildren;
    public final String fDisplayName;
    public volatile Class<?> fTestClass;
    public final Serializable fUniqueId;
