...
/* renamed from: f.a.f.b.b */
/* compiled from: MethodCallHandlerImpl */
public class C9071b implements C9017j.C9021c {

    /* renamed from: m */
    public static final String[] f17811m = new String[0];

    /* renamed from: e */
    public final ContentResolver f17812e;

    /* renamed from: l */
    public final PackageManager f17813l;

    public C9071b(ContentResolver contentResolver, PackageManager packageManager) {
        this.f17812e = contentResolver;
        this.f17813l = packageManager;
    }

    @SuppressLint({"HardwareIds"})
    /* renamed from: a */
    public final String mo46745a() {
        return Settings.Secure.getString(this.f17812e, "android_id");
    }

    /* renamed from: b */
    public final String[] mo46746b() {
        FeatureInfo[] systemAvailableFeatures = this.f17813l.getSystemAvailableFeatures();
    ...
    public void onMethodCall(C9016i iVar, C9017j.C9022d dVar) {
        if (iVar.f17687a.equals("getAndroidDeviceInfo")) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                hashMap.put("supported32BitAbis", Arrays.asList(f17811m));
                hashMap.put("supported64BitAbis", Arrays.asList(f17811m));
                hashMap.put("supportedAbis", Arrays.asList(f17811m));
            }
            hashMap.put("tags", Build.TAGS);
            hashMap.put("type", Build.TYPE);
            hashMap.put("isPhysicalDevice", Boolean.valueOf(!mo46747c()));
            hashMap.put("androidId", mo46745a());
            hashMap.put("systemFeatures", Arrays.asList(mo46746b()));
