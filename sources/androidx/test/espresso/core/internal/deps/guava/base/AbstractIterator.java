...
public abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    public static /* synthetic */ class C10271 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.test.espresso.core.internal.deps.guava.base.AbstractIterator.C10271.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C10271.$SwitchMap$com$google$common$base$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i != 2) {
