...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:4:?, code lost:
            r1 = (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture.UnsafeAtomicHelper.C10761());
         */
        ...
        static {
            ...
            L_0x0053:
                r0 = move-exception
                androidx.test.espresso.core.internal.deps.guava.base.Throwables.throwIfUnchecked(r0)
    ...
    static {
        ...
        if (th != null) {
            log.logp(Level.SEVERE, "androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture", "<clinit>", "UnsafeAtomicHelper is broken!", th2);
            log.logp(Level.SEVERE, "androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture", "<clinit>", "SafeAtomicHelper is broken!", th);
        }
    }
    ...
    public static void executeListener(Runnable runnable, Executor executor) {
        try {
            ...
            sb.append(valueOf2);
            logger.logp(level, "androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture", "executeListener", sb.toString(), e);
        }
    }
    ...
    public boolean cancel(boolean r8) {
        ...
        L_0x001f:
            ...
            androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture$Cancellation r3 = androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture.Cancellation.CAUSELESS_INTERRUPTED
            goto L_0x0026
        L_0x0024:
            androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture$Cancellation r3 = androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture.Cancellation.CAUSELESS_CANCELLED
        L_0x0026:
            r4 = r7
            r5 = r2
        L_0x0028:
            androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture$AtomicHelper r6 = ATOMIC_HELPER
        ...
        L_0x0035:
            ...
            androidx.test.espresso.core.internal.deps.guava.util.concurrent.ListenableFuture<? extends V> r0 = r0.future
        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos + 1000 < 0) {
                ...
                if (i > 0) {
                    ...
                    if (z) {
                        sb4 = String.valueOf(sb4).concat(RunnerArgs.CLASS_SEPARATOR);
                    }
    ...
    public String pendingToString() {
        ...
        if (obj instanceof SetFuture) {
            String userObjectToString = userObjectToString(((SetFuture) obj).future);
