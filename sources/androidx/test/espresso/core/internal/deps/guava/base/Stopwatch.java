...
public final class Stopwatch {
    ...
    public final Ticker ticker = Ticker.systemTicker();

    /* renamed from: androidx.test.espresso.core.internal.deps.guava.base.Stopwatch$1 */
    public static /* synthetic */ class C10321 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.test.espresso.core.internal.deps.guava.base.Stopwatch.C10321.<clinit>():void");
        }
    }

    public static String abbreviate(TimeUnit timeUnit) {
        switch (C10321.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
