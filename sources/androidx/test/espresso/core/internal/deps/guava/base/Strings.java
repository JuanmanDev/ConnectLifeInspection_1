...
public final class Strings {
    ...
    public static String lenientToString(Object obj) {
        try {
            ...
            logger.logp(level, "androidx.test.espresso.core.internal.deps.guava.base.Strings", "lenientToString", valueOf.length() != 0 ? "Exception during lenientFormat for ".concat(valueOf) : new String("Exception during lenientFormat for "), e);
