...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    public static /* synthetic */ class C10641 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.test.espresso.core.internal.deps.guava.collect.AbstractIterator.C10641.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C10641.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
