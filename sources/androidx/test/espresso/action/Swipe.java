...
public enum Swipe implements Swiper {
    ...
    public static final int SWIPE_EVENT_COUNT = 10;
    public static final int SWIPE_FAST_DURATION_MS = 150;
    public static final int SWIPE_SLOW_DURATION_MS = 1500;
    ...
    public static float[][] interpolate(float[] fArr, float[] fArr2, int i) {
