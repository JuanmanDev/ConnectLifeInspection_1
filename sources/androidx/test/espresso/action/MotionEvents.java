...
public final class MotionEvents {
    ...
    public static final String TAG = "MotionEvents";
    ...
    public static MotionEvent downPressGingerBread(long j, float[] fArr, float[] fArr2) {
        return MotionEvent.obtain(j, SystemClock.uptimeMillis(), 0, fArr[0], fArr[1], 0.0f, 1.0f, 0, fArr2[0], fArr2[1], 0, 0);
    }

    public static MotionEvent downPressICS(long j, float[] fArr, float[] fArr2, int i, int i2) {
    ...
    public static MotionEvent.PointerProperties[] getPointerProperties(int i) {
    ...
    public static void sendCancel(UiController uiController, MotionEvent motionEvent) {
        ...
        try {
            ...
            if (!uiController.injectMotionEvent(obtain)) {
                String.format(Locale.ROOT, "Injection of cancel event failed (corresponding down event: %s)", new Object[]{motionEvent});
                if (obtain != null) {
                    obtain.recycle();
                }
            } else if (obtain != null) {
            ...
            throw new PerformException.Builder().withActionDescription(String.format(Locale.ROOT, "inject cancel event (corresponding down event: %s)", new Object[]{motionEvent})).withViewDescription(EnvironmentCompat.MEDIA_UNKNOWN).withCause(e).build();
        } catch (Throwable th) {
    ...
    public static boolean sendMovement(UiController uiController, MotionEvent motionEvent, float[] fArr) {
        ...
        try {
            ...
            if (!uiController.injectMotionEvent(obtainMovement)) {
                String.format(Locale.ROOT, "Injection of motion event failed (corresponding down event: %s)", new Object[]{motionEvent});
            ...
            throw new PerformException.Builder().withActionDescription(String.format(Locale.ROOT, "inject motion event (corresponding down event: %s)", new Object[]{motionEvent})).withViewDescription(EnvironmentCompat.MEDIA_UNKNOWN).withCause(e).build();
        } catch (Throwable th) {
            if (motionEvent2 != null) {
                motionEvent2.recycle();
            }
    ...
    public static MotionEvent upPressGingerBread(MotionEvent motionEvent, float[] fArr) {
        return MotionEvent.obtain(motionEvent.getDownTime(), SystemClock.uptimeMillis(), 1, fArr[0], fArr[1], 0);
    }

    public static MotionEvent upPressICS(MotionEvent motionEvent, float[] fArr) {
        MotionEvent.PointerCoords[] pointerCoordsArr = {new MotionEvent.PointerCoords()};
    ...
    public static DownResultHolder sendDown(UiController uiController, float[] fArr, float[] fArr2, int i, int i2) {
        ...
        while (true) {
            ...
            if (i3 < 3) {
                ...
                throw new PerformException.Builder().withActionDescription(String.format(Locale.ROOT, "click (after %s attempts)", new Object[]{3})).withViewDescription(EnvironmentCompat.MEDIA_UNKNOWN).build();
            }
        }
    }
    ...
    public static boolean sendUp(UiController uiController, MotionEvent motionEvent, float[] fArr) {
        ...
        try {
            ...
            if (!uiController.injectMotionEvent(obtainUpEvent)) {
                String.format(Locale.ROOT, "Injection of up event failed (corresponding down event: %s)", new Object[]{motionEvent});
            ...
            throw new PerformException.Builder().withActionDescription(String.format(Locale.ROOT, "inject up event (corresponding down event: %s)", new Object[]{motionEvent})).withViewDescription(EnvironmentCompat.MEDIA_UNKNOWN).withCause(e).build();
        } catch (Throwable th) {
            if (motionEvent2 != null) {
                motionEvent2.recycle();
            }
