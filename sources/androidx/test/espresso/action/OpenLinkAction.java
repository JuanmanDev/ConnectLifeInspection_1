...
public final class OpenLinkAction implements ViewAction {
    public final C9623e<String> linkTextMatcher;
    public final C9623e<Uri> uriMatcher;

    /* JADX WARNING: type inference failed for: r1v0, types: [java.lang.Object, m.c.e<java.lang.String>] */
    /* JADX WARNING: type inference failed for: r2v0, types: [m.c.e<android.net.Uri>, java.lang.Object] */
    /* JADX WARNING: Unknown variable types count: 2 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public OpenLinkAction(p648m.p657c.C9623e<java.lang.String> r1, p648m.p657c.C9623e<android.net.Uri> r2) {
        /*
            r0 = this;
            r0.<init>()
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.test.espresso.action.OpenLinkAction.<init>(m.c.e, m.c.e):void");
    }

    public C9623e<View> getConstraints() {
        return C9624f.m25837b(ViewMatchers.isDisplayed(), ViewMatchers.isAssignableFrom(TextView.class), ViewMatchers.hasLinks());
    }
