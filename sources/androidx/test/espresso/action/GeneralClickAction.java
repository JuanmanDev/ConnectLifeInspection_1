...
public final class GeneralClickAction implements ViewAction {
    public static final String TAG = "GeneralClickAction";
    public final int buttonState;
    public final CoordinatesProvider coordinatesProvider;
    public final int inputDevice;
    public final PrecisionDescriber precisionDescriber;
    public final Optional<ViewAction> rollbackAction;
    public final Tapper tapper;
    ...
    public C9623e<View> getConstraints() {
        C9623e<View> isDisplayingAtLeast = ViewMatchers.isDisplayingAtLeast(90);
        return this.rollbackAction.isPresent() ? C9624f.m25836a(isDisplayingAtLeast, this.rollbackAction.get().getConstraints()) : isDisplayingAtLeast;
    }
