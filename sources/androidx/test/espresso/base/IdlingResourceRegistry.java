...
public final class IdlingResourceRegistry {
    public static final int DYNAMIC_RESOURCE_HAS_IDLED = 1;
    public static final int IDLE_WARNING_REACHED = 3;
    ...
    public static final int POSSIBLE_RACE_CONDITION_DETECTED = 4;
    ...
    public class Dispatcher implements Handler.Callback {
        ...
        private void handleResourceIdled(Message message) {
            ...
            if (z2) {
                String unused = IdlingResourceRegistry.TAG;
    ...
    public static class IdlingState implements IdlingResource.ResourceCallback {
        public final Handler handler;
        public boolean idle;
        public final IdlingResource resource;
        ...
        public IdlingState(IdlingResource idlingResource, Handler handler2) {
    ...
    public IdlingResourceRegistry(Looper looper2) {
        ...
        this.handler = new Handler(looper2, this.dispatcher);
    }
    ...
    public List<IdlingResource> getResources() {
        ...
        for (IdlingState idlingState : this.idlingStates) {
            builder.add((Object) idlingState.resource);
        }
    ...
    public void sync(final Iterable<IdlingResource> iterable, final Iterable<Looper> iterable2) {
        ...
        for (IdlingState next2 : this.idlingStates) {
            ...
            if (idlingResource == null) {
                ...
                IdlingResource idlingResource2 = next2.resource;
                if (idlingResource2 != idlingResource) {
                    arrayList.add(idlingResource2);
    ...
    public boolean unregisterResources(final List<? extends IdlingResource> list) {
        ...
        for (IdlingResource idlingResource : list) {
            ...
            if (!z) {
                String.format(Locale.ROOT, "Attempted to unregister resource that is not registered: '%s'. Resource list: %s", new Object[]{idlingResource.getName(), getResources()});
                z2 = false;
            }
        }
        return z2;
