...
public final class OrchestrationListenerManager {
    ...
    public ParcelableDescription lastDescription;
    public final List<OrchestrationRunListener> listeners = new ArrayList();
    public boolean markTerminationAsFailure = false;

    /* renamed from: androidx.test.orchestrator.listeners.OrchestrationListenerManager$1 */
    public static /* synthetic */ class C11331 {

        /* renamed from: $SwitchMap$androidx$test$orchestrator$listeners$OrchestrationListenerManager$TestEvent */
        public static final /* synthetic */ int[] f291x9b59c564;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f291x9b59c564     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f291x9b59c564     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f291x9b59c564     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f291x9b59c564     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f291x9b59c564     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f291x9b59c564     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.test.orchestrator.listeners.OrchestrationListenerManager.C11331.<clinit>():void");
        }
    }
    ...
    private void cacheStatus(Bundle bundle) {
        ...
        int i = C11331.f291x9b59c564[TestEvent.valueOf(bundle.getString(KEY_TEST_EVENT)).ordinal()];
        if (i == 1) {
    ...
    private void handleNotificationForListener(OrchestrationRunListener orchestrationRunListener, Bundle bundle) {
        switch (C11331.f291x9b59c564[TestEvent.valueOf(bundle.getString(KEY_TEST_EVENT)).ordinal()]) {
            case 1:
