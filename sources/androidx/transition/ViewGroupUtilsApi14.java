...
public class ViewGroupUtilsApi14 {
    ...
    public static void suppressLayout(@NonNull ViewGroup viewGroup, boolean z) {
        ...
        if (sEmptyLayoutTransition == null) {
            C11861 r0 = new LayoutTransition() {
        ...
        if (z) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    viewGroup.setTag(C1171R.C1174id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) viewGroup.getTag(C1171R.C1174id.transition_layout_save);
        if (layoutTransition2 != null) {
            viewGroup.setTag(C1171R.C1174id.transition_layout_save, (Object) null);
