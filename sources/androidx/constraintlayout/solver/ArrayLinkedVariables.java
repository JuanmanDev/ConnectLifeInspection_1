...
public class ArrayLinkedVariables {
    ...
    public final void add(SolverVariable solverVariable, float f, boolean z) {
        if (f != 0.0f) {
            ...
            if (i == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f212id;
            ...
            this.mArrayIndices[i7] = solverVariable.f212id;
    ...
    public final boolean containsKey(SolverVariable solverVariable) {
        ...
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            if (this.mArrayIndices[i] == solverVariable.f212id) {
                return true;
            }
            i = this.mArrayNextIndices[i];
            i2++;
    ...
    public SolverVariable getPivotCandidate(boolean[] zArr, SolverVariable solverVariable) {
        ...
        while (i != -1 && i2 < this.currentSize) {
            if (this.mArrayValues[i] < 0.0f) {
                SolverVariable solverVariable3 = this.mCache.mIndexedVariables[this.mArrayIndices[i]];
                if ((zArr == null || !zArr[solverVariable3.f212id]) && solverVariable3 != solverVariable && ((type = solverVariable3.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR)) {
