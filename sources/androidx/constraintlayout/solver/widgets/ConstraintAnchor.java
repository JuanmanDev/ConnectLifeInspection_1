...
public class ConstraintAnchor {
    ...
    public static /* synthetic */ class C04811 {
        ...
        public static final /* synthetic */ int[] f213x4c44d048;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f213x4c44d048     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.widgets.ConstraintAnchor.C04811.<clinit>():void");
        }
    }
    ...
    public final ConstraintAnchor getOpposite() {
        switch (C04811.f213x4c44d048[this.mType.ordinal()]) {
            case 1:
            case 6:
            case 7:
            case 8:
    ...
    public boolean isSimilarDimensionConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (C04811.f213x4c44d048[type2.ordinal()]) {
            case 1:
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (C04811.f213x4c44d048[this.mType.ordinal()]) {
            ...
            case 9:
                return false;
            case 2:
                int i = C04811.f213x4c44d048[constraintAnchor.getType().ordinal()];
                if (i == 3 || i == 7) {
                    return true;
                }
                return false;
            case 3:
                int i2 = C04811.f213x4c44d048[constraintAnchor.getType().ordinal()];
                if (i2 == 2 || i2 == 7) {
                    return true;
                }
                return false;
            case 4:
                int i3 = C04811.f213x4c44d048[constraintAnchor.getType().ordinal()];
                if (i3 == 5 || i3 == 8) {
                    return true;
                }
                return false;
            case 5:
                int i4 = C04811.f213x4c44d048[constraintAnchor.getType().ordinal()];
                if (i4 == 4 || i4 == 8) {
                    return true;
                }
                return false;
            case 7:
                int i5 = C04811.f213x4c44d048[constraintAnchor.getType().ordinal()];
                if (i5 == 2 || i5 == 3) {
                    return true;
                }
                return false;
            case 8:
                int i6 = C04811.f213x4c44d048[constraintAnchor.getType().ordinal()];
                if (i6 == 4 || i6 == 5) {
                    return true;
                }
                return false;
    ...
    public String toString() {
        return this.mOwner.getDebugName() + RunnerArgs.CLASSPATH_SEPARATOR + this.mType.toString();
    }
