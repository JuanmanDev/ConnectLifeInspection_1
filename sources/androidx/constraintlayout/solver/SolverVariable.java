...
public class SolverVariable {
    ...
    public static /* synthetic */ class C04801 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.SolverVariable.C04801.<clinit>():void");
        }
    }
    ...
    public static String getUniqueName(Type type, String str) {
        ...
        int i = C04801.$SwitchMap$androidx$constraintlayout$solver$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
