...
public final class TableInfo {
    ...
    public static final class Column {
        ...
        public static boolean containsSurroundingParenthesis(@NonNull String str) {
            if (str.length() == 0) {
                return false;
            }
            int i = 0;
    ...
    public static List<ForeignKeyWithSequence> readForeignKeyFieldMappings(Cursor cursor) {
        ...
        int columnIndex4 = cursor.getColumnIndex(MailTo.f233TO);
    ...
    public static Set<Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            int columnIndex = query.getColumnIndex("name");
            int columnIndex2 = query.getColumnIndex(EventBusConstKt.ORIGIN);
