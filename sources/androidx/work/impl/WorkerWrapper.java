...
public class WorkerWrapper implements Runnable {
    ...
    @Nullable
    public C6316e<ListenableWorker.Result> mInnerFuture = null;
                ...
                if (workSpec == null) {
                    ...
                    if (listenableWorker == null) {
                        ...
                        if (!trySetRunning()) {
                            ...
                            final C6316e<Void> future = workForegroundRunnable.getFuture();
    ...
    @NonNull
    public C6316e<Boolean> getFuture() {
        return this.mFuture;
    }
    ...
    public void interrupt() {
        ...
        C6316e<ListenableWorker.Result> eVar = this.mInnerFuture;
        if (eVar != null) {
            z = eVar.isDone();
