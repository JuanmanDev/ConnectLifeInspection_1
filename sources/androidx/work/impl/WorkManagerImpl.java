...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(@NonNull Context context, @NonNull Configuration configuration, @NonNull TaskExecutor taskExecutor) {
        this(context, configuration, taskExecutor, context.getResources().getBoolean(C1251R.bool.workmanager_test_configuration));
    }
    ...
    @NonNull
    public C6316e<Long> getLastCancelAllTimeMillis() {
    ...
    @NonNull
    public C6316e<WorkInfo> getWorkInfoById(@NonNull UUID uuid) {
    ...
    @NonNull
    public C6316e<List<WorkInfo>> getWorkInfos(@NonNull WorkQuery workQuery) {
    ...
    @NonNull
    public C6316e<List<WorkInfo>> getWorkInfosByTag(@NonNull String str) {
    ...
    @NonNull
    public C6316e<List<WorkInfo>> getWorkInfosForUniqueWork(@NonNull String str) {
