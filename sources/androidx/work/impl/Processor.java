...
public class Processor implements ExecutionListener, ForegroundProcessor {
    ...
    public static class FutureListener implements Runnable {
        ...
        @NonNull
        public C6316e<Boolean> mFuture;
        @NonNull
        public String mWorkSpecId;

        public FutureListener(@NonNull ExecutionListener executionListener, @NonNull String str, @NonNull C6316e<Boolean> eVar) {
    ...
    public boolean startWork(@NonNull String str, @Nullable WorkerParameters.RuntimeExtras runtimeExtras) {
        synchronized (this.mLock) {
            ...
            C6316e<Boolean> future = build.getFuture();
