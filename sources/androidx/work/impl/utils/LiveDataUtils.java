                ...
                TaskExecutor.this.executeOnBackgroundThread(new Runnable() {
                    public void run() {
                        synchronized (obj) {
                            ...
                            if (C13091.this.mCurrentOutput == null && apply != null) {
                                C13091.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            } else if (C13091.this.mCurrentOutput != null && !C13091.this.mCurrentOutput.equals(apply)) {
                                C13091.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            }
                        }
