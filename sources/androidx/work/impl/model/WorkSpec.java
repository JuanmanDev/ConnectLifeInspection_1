...
public final class WorkSpec {
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f296id.equals(idAndState.f296id);
        }

        public int hashCode() {
            return (this.f296id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public boolean equals(Object obj) {
            ...
            if (str == null ? workInfoPojo.f297id != null : !str.equals(workInfoPojo.f297id)) {
                return false;
            }
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f297id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((this.f295id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
