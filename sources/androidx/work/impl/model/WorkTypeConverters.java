...
public class WorkTypeConverters {
    ...
    public static /* synthetic */ class C13041 {
        ...
        static {
            ...
            L_0x00b8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.model.WorkTypeConverters.C13041.<clinit>():void");
        }
    }
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C13041.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int networkTypeToInt(NetworkType networkType) {
        int i = C13041.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int outOfQuotaPolicyToInt(@NonNull OutOfQuotaPolicy outOfQuotaPolicy) {
        int i = C13041.$SwitchMap$androidx$work$OutOfQuotaPolicy[outOfQuotaPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int stateToInt(WorkInfo.State state) {
        switch (C13041.$SwitchMap$androidx$work$WorkInfo$State[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
