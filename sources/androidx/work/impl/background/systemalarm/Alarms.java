...
public class Alarms {
    ...
    public static void cancelExactAlarm(@NonNull Context context, @NonNull String str, int i) {
    ...
    public static void setExactAlarm(@NonNull Context context, @NonNull String str, int i, long j) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(NotificationCompat.CATEGORY_ALARM);
