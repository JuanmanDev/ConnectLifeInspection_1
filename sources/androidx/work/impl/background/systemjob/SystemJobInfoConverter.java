...
public class SystemJobInfoConverter {
    ...
    public static /* synthetic */ class C12711 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.background.systemjob.SystemJobInfoConverter.C12711.<clinit>():void");
        }
    }
    ...
    public static int convertNetworkType(NetworkType networkType) {
        int i = C12711.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public JobInfo convert(WorkSpec workSpec, int i) {
        ...
        persistableBundle.putString(EXTRA_WORK_SPEC_ID, workSpec.f295id);
