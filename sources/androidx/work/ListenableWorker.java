...
public abstract class ListenableWorker {
    ...
    @NonNull
    public C6316e<ForegroundInfo> getForegroundInfoAsync() {
    ...
    @NonNull
    public final C6316e<Void> setForegroundAsync(@NonNull ForegroundInfo foregroundInfo) {
        this.mRunInForeground = true;
        return this.mWorkerParams.getForegroundUpdater().setForegroundAsync(getApplicationContext(), getId(), foregroundInfo);
    }

    @NonNull
    public C6316e<Void> setProgressAsync(@NonNull Data data) {
    ...
    @MainThread
    @NonNull
    public abstract C6316e<Result> startWork();
