...
import androidx.cardview.C0470R;
...
public class CardView extends FrameLayout {
    ...
    public void setContentPadding(@C0185Px int i, @C0185Px int i2, @C0185Px int i3, @C0185Px int i4) {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0470R.attr.cardViewStyle);
    }
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(C0470R.styleable.CardView_cardBackgroundColor)) {
            valueOf = obtainStyledAttributes.getColorStateList(C0470R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (fArr[2] > 0.5f) {
                i2 = getResources().getColor(C0470R.C0471color.cardview_light_background);
            } else {
                i2 = getResources().getColor(C0470R.C0471color.cardview_dark_background);
            }
