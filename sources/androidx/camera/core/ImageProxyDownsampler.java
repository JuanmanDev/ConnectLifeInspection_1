...
public final class ImageProxyDownsampler {
    ...
    public static /* synthetic */ class C04252 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f210x2bb1831c     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.ImageProxyDownsampler.C04252.<clinit>():void");
        }
    }
    ...
    public static final class ForwardingImageProxyImpl extends ForwardingImageProxy {
        public final int mDownsampledHeight;
        public final ImageProxy.PlaneProxy[] mDownsampledPlanes;
        public final int mDownsampledWidth;

        public ForwardingImageProxyImpl(ImageProxy imageProxy, ImageProxy.PlaneProxy[] planeProxyArr, int i, int i2) {
            super(imageProxy);
    ...
    public static ImageProxy.PlaneProxy createPlaneProxy(final int i, final int i2, final byte[] bArr) {
        return new ImageProxy.PlaneProxy() {
            public final ByteBuffer mBuffer = ByteBuffer.wrap(bArr);
    ...
    public static ForwardingImageProxy downsample(ImageProxy imageProxy, int i, int i2, DownsamplingMethod downsamplingMethod) {
        byte[] bArr;
        ...
        if (imageProxy.getFormat() != 35) {
            ...
            throw new IllegalArgumentException("Downsampled dimension " + new Size(i3, i4) + " is not <= original dimension " + new Size(imageProxy.getWidth(), imageProxy.getHeight()) + MAPCookie.DOT);
        } else if (imageProxy.getWidth() == i3 && imageProxy.getHeight() == i4) {
            ...
            for (int i7 = 0; i7 < 3; i7++) {
                ...
                int i8 = C04252.f210x2bb1831c[downsamplingMethod.ordinal()];
                if (i8 == 1) {
                    bArr = bArr2;
    ...
    public static void resizeAveraging(ByteBuffer byteBuffer, int i, int i2, int i3, int i4, byte[] bArr, int i5, int i6) {
    ...
    public static void resizeNearestNeighbor(ByteBuffer byteBuffer, int i, int i2, int i3, int i4, byte[] bArr, int i5, int i6) {
