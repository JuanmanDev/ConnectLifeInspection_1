...
public final class SequentialExecutor implements Executor {
    ...
    public final QueueWorker mWorker = new QueueWorker();
    @GuardedBy("mQueue")
    ...
    public final class QueueWorker implements Runnable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:?, code lost:
            "Exception while executing runnable " + r3;
         */
        ...
        private void workOnQueue() {
            /*
                ...
                r1 = r0
            L_0x0002:
                androidx.camera.core.impl.utils.executor.SequentialExecutor r2 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x0067 }
                java.util.Deque<java.lang.Runnable> r2 = r2.mQueue     // Catch:{ all -> 0x0067 }
                monitor-enter(r2)     // Catch:{ all -> 0x0067 }
                if (r0 != 0) goto L_0x002c
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x0064 }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r0 = r0.mWorkerRunningState     // Catch:{ all -> 0x0064 }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r3 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.RUNNING     // Catch:{ all -> 0x0064 }
            ...
            L_0x001c:
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x0064 }
                long r3 = r0.mWorkerRunCount     // Catch:{ all -> 0x0064 }
                r5 = 1
                long r3 = r3 + r5
                r0.mWorkerRunCount = r3     // Catch:{ all -> 0x0064 }
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x0064 }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r3 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.RUNNING     // Catch:{ all -> 0x0064 }
                r0.mWorkerRunningState = r3     // Catch:{ all -> 0x0064 }
                r0 = 1
            L_0x002c:
                androidx.camera.core.impl.utils.executor.SequentialExecutor r3 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x0064 }
                java.util.Deque<java.lang.Runnable> r3 = r3.mQueue     // Catch:{ all -> 0x0064 }
                java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x0064 }
                java.lang.Runnable r3 = (java.lang.Runnable) r3     // Catch:{ all -> 0x0064 }
                if (r3 != 0) goto L_0x0049
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x0064 }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r3 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.IDLE     // Catch:{ all -> 0x0064 }
                r0.mWorkerRunningState = r3     // Catch:{ all -> 0x0064 }
                monitor-exit(r2)     // Catch:{ all -> 0x0064 }
            ...
            L_0x0049:
                monitor-exit(r2)     // Catch:{ all -> 0x0064 }
                boolean r2 = java.lang.Thread.interrupted()     // Catch:{ all -> 0x0067 }
                r1 = r1 | r2
