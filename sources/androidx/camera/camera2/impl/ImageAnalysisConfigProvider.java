...
public final class ImageAnalysisConfigProvider implements ConfigProvider<ImageAnalysisConfig> {
    ...
    public static final String TAG = "ImageAnalysisProvider";
    ...
    public ImageAnalysisConfig getConfig(CameraX.LensFacing lensFacing) {
        List list;
        ImageAnalysisConfig.Builder fromConfig = ImageAnalysisConfig.Builder.fromConfig(ImageAnalysis.DEFAULT_CONFIG.getConfig(lensFacing));
