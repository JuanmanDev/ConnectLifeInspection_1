...
public class WebViewGlueCommunicator {
    ...
    public static WebViewProviderFactory createGlueProviderFactory() {
        ...
        try {
            return new WebViewProviderFactoryAdapter((WebViewProviderFactoryBoundaryInterface) C9616a.m25809a(WebViewProviderFactoryBoundaryInterface.class, fetchGlueProviderFactoryImpl()));
