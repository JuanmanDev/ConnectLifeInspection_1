...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @Deprecated
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo840to = 1000) int i2, boolean z, int i3) {
        ...
        public static FontInfo create(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo840to = 1000) int i2, boolean z, int i3) {
