...
import p001a.p007c.p012d.C0052a;

public class FontProvider {
    public static final Comparator<byte[]> sByteArrayComparator = C0052a.f80e;
    ...
    public static /* synthetic */ int m67a(byte[] r4, byte[] r5) {
        /*
            int r0 = r4.length
            int r1 = r5.length
        ...
        L_0x001b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontProvider.m67a(byte[], byte[]):int");
    }
    ...
    public static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        String str2 = str;
        ArrayList arrayList = new ArrayList();
        Uri build = new Uri.Builder().scheme(BrowserServiceFileProvider.CONTENT_SCHEME).authority(str2).build();
        Uri build2 = new Uri.Builder().scheme(BrowserServiceFileProvider.CONTENT_SCHEME).authority(str2).appendPath("file").build();
        Cursor cursor = null;
        try {
