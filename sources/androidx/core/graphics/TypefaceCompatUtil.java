...
public class TypefaceCompatUtil {
    ...
    public static File getTempFile(@NonNull Context context) {
        ...
        String str = CACHE_FILE_PREFIX + Process.myPid() + AccountManagerConstants$LOCALE.LOCALE_SEPERATOR + Process.myTid() + AccountManagerConstants$LOCALE.LOCALE_SEPERATOR;
        int i = 0;
        while (i < 100) {
