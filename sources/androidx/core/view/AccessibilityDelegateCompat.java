...
public class AccessibilityDelegateCompat {
    ...
    public static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C0493R.C0496id.tag_accessibility_actions);
    ...
    private boolean performClickableSpanAction(int i, View view) {
        ...
        SparseArray sparseArray = (SparseArray) view.getTag(C0493R.C0496id.tag_accessibility_clickable_spans);
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i, @Nullable Bundle bundle) {
        ...
        return (z || i != C0493R.C0496id.accessibility_action_clickable_span || bundle == null) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
