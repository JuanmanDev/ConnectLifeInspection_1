...
import p001a.p007c.p016g.p017l.C0070a;
...
public final class InputConnectionCompat {
    ...
    /* renamed from: a */
    public static /* synthetic */ boolean m86a(View view, InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
    ...
    @NonNull
    public static OnCommitContentListener createOnCommitContentListenerUsingPerformReceiveContent(@NonNull View view) {
    ...
    public static boolean handlePerformPrivateCommand(@androidx.annotation.Nullable java.lang.String r7, @androidx.annotation.Nullable android.os.Bundle r8, @androidx.annotation.NonNull androidx.core.view.inputmethod.InputConnectionCompat.OnCommitContentListener r9) {
        /*
            r0 = 0
