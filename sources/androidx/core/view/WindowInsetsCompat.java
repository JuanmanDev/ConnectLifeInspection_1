...
public class WindowInsetsCompat {
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (!(rect == null || rect2 == null)) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m42of(rect)).setSystemWindowInsets(Insets.m42of(rect2)).build();
    ...
    public static class Impl20 extends Impl {
                ...
                if (i != 2) {
                    if (i == 8) {
                        ...
                        if (displayCutoutCompat != null) {
                            return Insets.m41of(displayCutoutCompat.getSafeInsetLeft(), displayCutoutCompat.getSafeInsetTop(), displayCutoutCompat.getSafeInsetRight(), displayCutoutCompat.getSafeInsetBottom());
                        }
                        return Insets.NONE;
                    }
                } else if (z) {
                    ...
                    return Insets.m41of(Math.max(rootStableInsets2.left, stableInsets.left), 0, Math.max(rootStableInsets2.right, stableInsets.right), Math.max(rootStableInsets2.bottom, stableInsets.bottom));
                } else {
                    ...
                    return Insets.m41of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i4);
                }
            } else if (z) {
                return Insets.m41of(0, Math.max(getRootStableInsets().f19491top, getSystemWindowInsets().f19491top), 0, 0);
            } else {
                return Insets.m41of(0, getSystemWindowInsets().f19491top, 0, 0);
            }
        }
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m41of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f19491top - i2);
        int max3 = Math.max(0, insets.right - i3);
        int max4 = Math.max(0, insets.bottom - i4);
        if (max == i && max2 == i2 && max3 == i3 && max4 == i4) {
            return insets;
        }
        return Insets.m41of(max, max2, max3, max4);
    }
    ...
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f19491top;
    }
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f19491top;
    }
    ...
    public WindowInsetsCompat inset(@NonNull Insets insets) {
        return inset(insets.left, insets.f19491top, insets.right, insets.bottom);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m41of(i, i2, i3, i4)).build();
    }
    ...
    public static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(@NonNull Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f19491top, insets.right, insets.bottom);
            }
        }
    ...
    public static class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m41of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(@NonNull Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m42of(rect)).build();
    }
