...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static BoundsCompat computeAnimationBounds(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2, int i) {
            ...
            return new BoundsCompat(Insets.m41of(Math.min(insets.left, insets2.left), Math.min(insets.f19491top, insets2.f19491top), Math.min(insets.right, insets2.right), Math.min(insets.bottom, insets2.bottom)), Insets.m41of(Math.max(insets.left, insets2.left), Math.max(insets.f19491top, insets2.f19491top), Math.max(insets.right, insets2.right), Math.max(insets.bottom, insets2.bottom)));
        }
        ...
        public static WindowInsets forwardToViewIfNeeded(@NonNull View view, @NonNull WindowInsets windowInsets) {
            if (view.getTag(C0493R.C0496id.tag_on_apply_window_listener) != null) {
                return windowInsets;
            }
        ...
        public static Callback getCallback(View view) {
            Object tag = view.getTag(C0493R.C0496id.tag_window_insets_animation_callback);
        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f, int i) {
            ...
            for (int i2 = 1; i2 <= 256; i2 <<= 1) {
                if ((i & i2) == 0) {
                    ...
                    float f2 = 1.0f - f;
                    builder.setInsets(i2, WindowInsetsCompat.insetInsets(insets, (int) (((double) (((float) (insets.left - insets2.left)) * f2)) + 0.5d), (int) (((double) (((float) (insets.f19491top - insets2.f19491top)) * f2)) + 0.5d), (int) (((double) (((float) (insets.right - insets2.right)) * f2)) + 0.5d), (int) (((double) (((float) (insets.bottom - insets2.bottom)) * f2)) + 0.5d)));
                }
            }
        ...
        public static void setCallback(@NonNull View view, @Nullable Callback callback) {
            Object tag = view.getTag(C0493R.C0496id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0493R.C0496id.tag_window_insets_animation_callback, (Object) null);
                if (tag == null) {
            ...
            view.setTag(C0493R.C0496id.tag_window_insets_animation_callback, createProxyListener);
            if (tag == null) {
    ...
    public void setAlpha(@FloatRange(from = 0.0d, mo822to = 1.0d) float f) {
        this.mImpl.setAlpha(f);
    }

    public void setFraction(@FloatRange(from = 0.0d, mo822to = 1.0d) float f) {
    ...
    public static final class BoundsCompat {
        ...
        public BoundsCompat inset(@NonNull Insets insets) {
            return new BoundsCompat(WindowInsetsCompat.insetInsets(this.mLowerBound, insets.left, insets.f19491top, insets.right, insets.bottom), WindowInsetsCompat.insetInsets(this.mUpperBound, insets.left, insets.f19491top, insets.right, insets.bottom));
        }
