...
import android.support.p025v4.app.INotificationSideChannel;
...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f224id, this.tag, this.notif);
        }

        @NonNull
        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.f224id + ", tag:" + this.tag + "]";
        }
    }
            ...
            if (!listenerRecord.taskQueue.isEmpty()) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        "RemoteException communicating with " + listenerRecord.componentName;
                    }
                }
                if (!listenerRecord.taskQueue.isEmpty()) {
                    scheduleListenerRetry(listenerRecord);
        ...
        synchronized (sEnabledNotificationListenersLock) {
            if (string != null) {
                if (!string.equals(sEnabledNotificationListeners)) {
                    String[] split = string.split(RunnerArgs.CLASSPATH_SEPARATOR, -1);
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f223id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.f223id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
