...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(@Nullable Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0493R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0493R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0493R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0493R.C0496id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0493R.C0496id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0493R.C0496id.actions, i);
            applyStandardTemplate.setViewVisibility(C0493R.C0496id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0493R.layout.notification_action_tombstone;
            } else {
                i = C0493R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0493R.C0496id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0493R.C0494color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0493R.C0496id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0493R.C0496id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0493R.C0496id.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0493R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0493R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0493R.C0495drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0493R.C0496id.title, 8);
            remoteViews.setViewVisibility(C0493R.C0496id.text2, 8);
            remoteViews.setViewVisibility(C0493R.C0496id.text, 8);
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:91:0x0221  */
        @androidx.annotation.NonNull
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x0023:
                ...
                int r14 = androidx.core.C0493R.C0496id.notification_background
                int r4 = androidx.core.C0493R.C0495drawable.notification_bg_low
                r7.setInt(r14, r2, r4)
                int r14 = androidx.core.C0493R.C0496id.icon
                int r4 = androidx.core.C0493R.C0495drawable.notification_template_icon_low_bg
                r7.setInt(r14, r2, r4)
                goto L_0x004e
            L_0x0040:
                int r14 = androidx.core.C0493R.C0496id.notification_background
                int r4 = androidx.core.C0493R.C0495drawable.notification_bg
                r7.setInt(r14, r2, r4)
                int r14 = androidx.core.C0493R.C0496id.icon
                int r4 = androidx.core.C0493R.C0495drawable.notification_template_icon_bg
                r7.setInt(r14, r2, r4)
            L_0x004e:
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x006e:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x00fc
                int r13 = androidx.core.C0493R.dimen.notification_right_icon_size
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = androidx.core.C0493R.dimen.notification_small_icon_background_padding
                ...
                int r14 = androidx.core.C0493R.C0496id.right_icon
                r7.setImageViewBitmap(r14, r13)
                goto L_0x00af
            L_0x00a0:
                int r13 = androidx.core.C0493R.C0496id.right_icon
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x00b5:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x00fc
                int r13 = androidx.core.C0493R.C0496id.icon
                r7.setViewVisibility(r13, r9)
                int r13 = android.os.Build.VERSION.SDK_INT
                if (r13 < r3) goto L_0x00ed
                int r13 = androidx.core.C0493R.dimen.notification_large_icon_width
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = androidx.core.C0493R.dimen.notification_big_circle_margin
                int r14 = r0.getDimensionPixelSize(r14)
                int r13 = r13 - r14
                int r14 = androidx.core.C0493R.dimen.notification_small_icon_size_as_large
                int r14 = r0.getDimensionPixelSize(r14)
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                android.app.Notification r2 = r1.mNotification
                int r2 = r2.icon
            ...
            L_0x00fc:
                ...
                int r14 = androidx.core.C0493R.C0496id.title
                r7.setTextViewText(r14, r13)
            L_0x0107:
                androidx.core.app.NotificationCompat$Builder r13 = r12.mBuilder
                java.lang.CharSequence r13 = r13.mContentText
                if (r13 == 0) goto L_0x0114
                int r14 = androidx.core.C0493R.C0496id.text
                r7.setTextViewText(r14, r13)
                r13 = r8
                goto L_0x0115
            L_0x0114:
            ...
            L_0x0122:
                ...
                int r13 = androidx.core.C0493R.C0496id.info
            ...
            L_0x0135:
                ...
                int r13 = androidx.core.C0493R.integer.status_bar_notification_info_maxnum
                int r13 = r0.getInteger(r13)
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
                int r14 = r14.mNumber
                if (r14 <= r13) goto L_0x0151
                int r13 = androidx.core.C0493R.C0496id.info
                int r14 = androidx.core.C0493R.string.status_bar_notification_info_overflow
                java.lang.String r14 = r0.getString(r14)
                r7.setTextViewText(r13, r14)
                goto L_0x0163
            L_0x0151:
                java.text.NumberFormat r13 = java.text.NumberFormat.getIntegerInstance()
                int r14 = androidx.core.C0493R.C0496id.info
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                int r1 = r1.mNumber
                long r1 = (long) r1
            ...
            L_0x0163:
                ...
                goto L_0x0132
            L_0x0169:
                int r1 = androidx.core.C0493R.C0496id.info
            ...
            L_0x016e:
                ...
                int r2 = androidx.core.C0493R.C0496id.text
                r7.setTextViewText(r2, r1)
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                java.lang.CharSequence r1 = r1.mContentText
                if (r1 == 0) goto L_0x018f
                int r2 = androidx.core.C0493R.C0496id.text2
                r7.setTextViewText(r2, r1)
                int r1 = androidx.core.C0493R.C0496id.text2
            ...
            L_0x0195:
                ...
                int r15 = androidx.core.C0493R.dimen.notification_subtext_size
                int r15 = r0.getDimensionPixelSize(r15)
                float r15 = (float) r15
                int r0 = androidx.core.C0493R.C0496id.text
                r7.setTextViewTextSize(r0, r9, r15)
            L_0x01a9:
                int r2 = androidx.core.C0493R.C0496id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x01b3:
                ...
                int r14 = android.os.Build.VERSION.SDK_INT
                if (r14 < r10) goto L_0x01fe
                int r14 = androidx.core.C0493R.C0496id.chronometer
                r7.setViewVisibility(r14, r9)
                int r14 = androidx.core.C0493R.C0496id.chronometer
                androidx.core.app.NotificationCompat$Builder r15 = r12.mBuilder
                long r0 = r15.getWhenIfShowing()
                ...
                int r15 = androidx.core.C0493R.C0496id.chronometer
                r7.setChronometerCountDown(r15, r14)
                goto L_0x0212
            L_0x01fe:
                int r14 = androidx.core.C0493R.C0496id.time
                r7.setViewVisibility(r14, r9)
                int r14 = androidx.core.C0493R.C0496id.time
                androidx.core.app.NotificationCompat$Builder r15 = r12.mBuilder
                long r0 = r15.getWhenIfShowing()
            ...
            L_0x0211:
                r8 = r14
            L_0x0212:
                int r14 = androidx.core.C0493R.C0496id.right_side
            ...
            L_0x0219:
                ...
                int r14 = androidx.core.C0493R.C0496id.line3
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0493R.C0496id.notification_main_column);
            remoteViews.addView(C0493R.C0496id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0493R.C0496id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0493R.C0496id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i3 = 0; i3 < remoteInputs.length; i3++) {
                ...
                remoteInputArr2[i3] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? remoteInput.getEditChoicesBeforeSending() : 0, remoteInput.getExtras(), (Set<String>) null);
            }
        ...
        boolean z5 = z2;
        if (Build.VERSION.SDK_INT < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i4, z4, isContextual, z5);
        }
        if (action.getIcon() == null && (i2 = action2.icon) != 0) {
            return new Action(i2, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i4, z4, isContextual, z5);
        }
        if (action.getIcon() != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(action.getIcon());
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i4, z4, isContextual, z5);
    }
