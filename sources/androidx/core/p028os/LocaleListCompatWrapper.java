...
public final class LocaleListCompatWrapper implements LocaleListInterface {
    ...
    public static final Locale LOCALE_AR_XB = new Locale(LanguageConstKt.f15938ar, "XB");
    public static final Locale LOCALE_EN_XA = new Locale(LanguageConstKt.f15944en, "XA");
    ...
    private int computeFirstMatchIndex(java.util.Collection<java.lang.String> r5, boolean r6) {
        ...
        L_0x0023:
            ...
            java.util.Locale r1 = androidx.core.p028os.LocaleListCompat.forLanguageTagCompat(r1)
        ...
        L_0x0041:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.p028os.LocaleListCompatWrapper.computeFirstMatchIndex(java.util.Collection, boolean):int");
    }
