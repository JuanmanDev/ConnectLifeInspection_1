...
public class FontResourcesParserCompat {
    ...
    public static androidx.core.content.res.FontResourcesParserCompat.FamilyResourceEntry parse(@androidx.annotation.NonNull org.xmlpull.p703v1.XmlPullParser r3, @androidx.annotation.NonNull android.content.res.Resources r4) {
        /*
        L_0x0000:
            int r0 = r3.next()
            r1 = 2
    ...
    public static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0493R.styleable.FontFamily);
        String string = obtainAttributes.getString(C0493R.styleable.FontFamily_fontProviderAuthority);
        String string2 = obtainAttributes.getString(C0493R.styleable.FontFamily_fontProviderPackage);
        String string3 = obtainAttributes.getString(C0493R.styleable.FontFamily_fontProviderQuery);
        int resourceId = obtainAttributes.getResourceId(C0493R.styleable.FontFamily_fontProviderCerts, 0);
        int integer = obtainAttributes.getInteger(C0493R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int integer2 = obtainAttributes.getInteger(C0493R.styleable.FontFamily_fontProviderFetchTimeout, 500);
        String string4 = obtainAttributes.getString(C0493R.styleable.FontFamily_fontProviderSystemFontFamily);
    ...
    public static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) {
        ...
        int i4;
        int i5;
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0493R.styleable.FontFamilyFont);
        if (obtainAttributes.hasValue(C0493R.styleable.FontFamilyFont_fontWeight)) {
            i = C0493R.styleable.FontFamilyFont_fontWeight;
        } else {
            i = C0493R.styleable.FontFamilyFont_android_fontWeight;
        }
        int i6 = obtainAttributes.getInt(i, 400);
        if (obtainAttributes.hasValue(C0493R.styleable.FontFamilyFont_fontStyle)) {
            i2 = C0493R.styleable.FontFamilyFont_fontStyle;
        } else {
            i2 = C0493R.styleable.FontFamilyFont_android_fontStyle;
        }
        boolean z = 1 == obtainAttributes.getInt(i2, 0);
        if (obtainAttributes.hasValue(C0493R.styleable.FontFamilyFont_ttcIndex)) {
            i3 = C0493R.styleable.FontFamilyFont_ttcIndex;
        } else {
            i3 = C0493R.styleable.FontFamilyFont_android_ttcIndex;
        }
        if (obtainAttributes.hasValue(C0493R.styleable.FontFamilyFont_fontVariationSettings)) {
            i4 = C0493R.styleable.FontFamilyFont_fontVariationSettings;
        } else {
            i4 = C0493R.styleable.FontFamilyFont_android_fontVariationSettings;
        }
        String string = obtainAttributes.getString(i4);
        int i7 = obtainAttributes.getInt(i3, 0);
        if (obtainAttributes.hasValue(C0493R.styleable.FontFamilyFont_font)) {
            i5 = C0493R.styleable.FontFamilyFont_font;
        } else {
            i5 = C0493R.styleable.FontFamilyFont_android_font;
        }
