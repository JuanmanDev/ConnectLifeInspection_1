...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatTextView> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            this.mAutoSizeMaxTextSizeId = propertyMapper.mapInt("autoSizeMaxTextSize", C0187R.attr.autoSizeMaxTextSize);
            this.mAutoSizeMinTextSizeId = propertyMapper.mapInt("autoSizeMinTextSize", C0187R.attr.autoSizeMinTextSize);
            this.mAutoSizeStepGranularityId = propertyMapper.mapInt("autoSizeStepGranularity", C0187R.attr.autoSizeStepGranularity);
            this.mAutoSizeTextTypeId = propertyMapper.mapIntEnum("autoSizeTextType", C0187R.attr.autoSizeTextType, new IntFunction<String>() {
            ...
            this.mDrawableTintId = propertyMapper.mapObject("drawableTint", C0187R.attr.drawableTint);
            this.mDrawableTintModeId = propertyMapper.mapObject("drawableTintMode", C0187R.attr.drawableTintMode);
    ...
    public void setFirstBaselineToTopHeight(@C0185Px @IntRange(from = 0) int i) {
    ...
    public void setLastBaselineToBottomHeight(@C0185Px @IntRange(from = 0) int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0185Px @IntRange(from = 0) int i) {
