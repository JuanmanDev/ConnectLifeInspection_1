...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void show(int i, int i2) {
            ...
            if (!isShowing && (viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                final C02512 r6 = new ViewTreeObserver.OnGlobalLayoutListener() {
    ...
    public AppCompatSpinner(@NonNull Context context, int i) {
        this(context, (AttributeSet) null, C0187R.attr.spinnerStyle, i);
    }
    ...
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0187R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(@androidx.annotation.NonNull android.content.Context r6, @androidx.annotation.Nullable android.util.AttributeSet r7, int r8, int r9, android.content.res.Resources.Theme r10) {
        /*
            ...
            int[] r0 = androidx.appcompat.C0187R.styleable.Spinner
            r1 = 0
            ...
            goto L_0x003b
        L_0x0029:
            int r10 = androidx.appcompat.C0187R.styleable.Spinner_popupTheme
        ...
        L_0x0069:
            ...
            r9.<init>(r3, r7, r8)
            android.content.Context r3 = r5.mPopupContext
            int[] r4 = androidx.appcompat.C0187R.styleable.Spinner
            ...
            int r3 = androidx.appcompat.C0187R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r3 = r1.getLayoutDimension((int) r3, (int) r4)
            r5.mDropDownWidth = r3
            int r3 = androidx.appcompat.C0187R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r3 = r1.getDrawable(r3)
            r9.setBackgroundDrawable(r3)
            int r3 = androidx.appcompat.C0187R.styleable.Spinner_android_prompt
        ...
        L_0x00a0:
            ...
            r9.<init>()
            r5.mPopup = r9
            int r1 = androidx.appcompat.C0187R.styleable.Spinner_android_prompt
            java.lang.String r1 = r0.getString(r1)
            r9.setPromptText(r1)
        L_0x00b0:
            int r9 = androidx.appcompat.C0187R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r9 = r0.getTextArray(r9)
            if (r9 == 0) goto L_0x00c8
            android.widget.ArrayAdapter r1 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r1.<init>(r6, r3, r9)
            int r6 = androidx.appcompat.C0187R.layout.support_simple_spinner_dropdown_item
