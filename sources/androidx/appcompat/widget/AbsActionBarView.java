...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes((AttributeSet) null, C0187R.styleable.ActionBar, C0187R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0187R.styleable.ActionBar_height, 0));
    ...
    public AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0187R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
