...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            ...
            this.mGravityId = propertyMapper.mapGravity(NotificationCompat.WearableExtender.KEY_GRAVITY, 16842927);
            ...
            this.mDividerId = propertyMapper.mapObject("divider", C0187R.attr.divider);
            this.mDividerPaddingId = propertyMapper.mapInt("dividerPadding", C0187R.attr.dividerPadding);
            this.mMeasureWithLargestChildId = propertyMapper.mapBoolean("measureWithLargestChild", C0187R.attr.measureWithLargestChild);
            this.mShowDividersId = propertyMapper.mapIntFlag("showDividers", C0187R.attr.showDividers, new IntFunction<Set<String>>() {
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0187R.styleable.LinearLayoutCompat, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        int i2 = obtainStyledAttributes.getInt(C0187R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0187R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i3 >= 0) {
            setGravity(i3);
        }
