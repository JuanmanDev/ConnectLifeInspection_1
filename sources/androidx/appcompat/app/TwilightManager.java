...
public class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        if (PermissionChecker.checkSelfPermission(this.mContext, PermissionConstKt.PERMISSION_LOCATION) == 0) {
            location = getLastKnownLocationForProvider(EventBusConstKt.GPS);
        }
