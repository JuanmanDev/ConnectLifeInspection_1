...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0617R.styleable.Fragment);
        if (attributeValue == null) {
            attributeValue = obtainStyledAttributes.getString(C0617R.styleable.Fragment_android_name);
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0617R.styleable.Fragment_android_id, -1);
        String string = obtainStyledAttributes.getString(C0617R.styleable.Fragment_android_tag);
        ...
        if (fragment == null) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                "Fragment " + fragment + " has been inflated via the <fragment> tag: id=0x" + Integer.toHexString(resourceId);
            }
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                "Retained Fragment " + fragment + " has been re-attached via the <fragment> tag: id=0x" + Integer.toHexString(resourceId);
            }
        } else {
