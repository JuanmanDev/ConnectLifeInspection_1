...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public static boolean isFragmentPostponed(FragmentTransaction.C0673Op op) {
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0673Op op = this.mOps.get(i2);
                Fragment fragment = op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        "Bump nesting of " + op.mFragment + " to " + op.mFragment.mBackStackNesting;
                    }
                }
            }
        }
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0673Op op = this.mOps.get(i);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0673Op op = this.mOps.get(size);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment4.mContainerId == i3) {
                            if (fragment4 == fragment3) {
                                ...
                                if (fragment4 == fragment2) {
                                    this.mOps.add(i, new FragmentTransaction.C0673Op(9, fragment4));
                                    i++;
                                    fragment2 = null;
                                }
                                FragmentTransaction.C0673Op op2 = new FragmentTransaction.C0673Op(3, fragment4);
                    ...
                    if (fragment5 == fragment2) {
                        this.mOps.add(i, new FragmentTransaction.C0673Op(9, fragment5));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new FragmentTransaction.C0673Op(9, fragment2));
                        i++;
