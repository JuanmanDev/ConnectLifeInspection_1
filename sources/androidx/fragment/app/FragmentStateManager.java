...
public class FragmentStateManager {
    ...
    public static /* synthetic */ class C06712 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C06712.<clinit>():void");
        }
    }
    ...
    public int computeExpectedState() {
        ...
        int i2 = C06712.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment2.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = Math.min(i, 5);
            } else if (i2 == 3) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            "computeExpectedState() of " + i + " for " + this.mFragment;
        }
        return i;
    }
    ...
    public void createView() {
        ...
        if (!this.mFragment.mFromLayout) {
            ...
            if (view != null) {
                ...
                Fragment fragment5 = this.mFragment;
                fragment5.mView.setTag(C0617R.C0620id.fragment_container_view_tag, fragment5);
                if (viewGroup != null) {
                    addViewToContainer();
                }
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C0617R.C0620id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
