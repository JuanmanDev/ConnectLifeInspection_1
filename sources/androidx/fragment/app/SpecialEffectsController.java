...
public abstract class SpecialEffectsController {
    ...
    public static /* synthetic */ class C06923 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f249xb9e640f0     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f249xb9e640f0     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0039:
                int[] r1 = f250xe493b431     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                int[] r0 = f250xe493b431     // Catch:{ NoSuchFieldError -> 0x004d }
            ...
            L_0x004d:
                int[] r0 = f250xe493b431     // Catch:{ NoSuchFieldError -> 0x0058 }
            ...
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.SpecialEffectsController.C06923.<clinit>():void");
        }
    }
    ...
    public static class Operation {
        ...
        public final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            int i = C06923.f249xb9e640f0[lifecycleImpact.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    if (FragmentManager.isLoggingEnabled(2)) {
        ...
        public enum State {
            ...
            public void applyState(@NonNull View view) {
                int i = C06923.f250xe493b431[ordinal()];
                if (i == 1) {
    ...
    public static SpecialEffectsController getOrCreateController(@NonNull ViewGroup viewGroup, @NonNull SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0617R.C0620id.special_effects_controller_view_tag);
        if (tag instanceof SpecialEffectsController) {
            return (SpecialEffectsController) tag;
        }
        SpecialEffectsController createController = specialEffectsControllerFactory.createController(viewGroup);
        viewGroup.setTag(C0617R.C0620id.special_effects_controller_view_tag, createController);
