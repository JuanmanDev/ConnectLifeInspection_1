...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        printWriter.print(str);
        printWriter.println("Child " + this.mChildFragmentManager + RunnerArgs.CLASSPATH_SEPARATOR);
        ...
        if (this.mFragmentManager != null) {
            if (this.mDefaultFactory == null) {
                ...
                if (application == null && FragmentManager.isLoggingEnabled(3)) {
                    "Could not find Application instance from Context " + requireContext().getApplicationContext() + ", you will not be able to use AndroidViewModel with the default ViewModelProvider.Factory";
                }
    ...
    public void onActivityResult(int i, int i2, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i + " resultCode: " + i2 + " data: " + intent;
        }
    }
    ...
    private void restoreViewState() {
        if (FragmentManager.isLoggingEnabled(3)) {
            "moveto RESTORE_VIEW_STATE: " + this;
        }
        if (this.mView != null) {
