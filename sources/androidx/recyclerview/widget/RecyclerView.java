...
import androidx.recyclerview.C0844R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0844R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0844R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0844R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0844R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0844R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void offsetChildrenHorizontal(@C0185Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0185Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0185Px int i, @C0185Px int i2) {
            ...
            public void setDx(@C0185Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@C0185Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0185Px int i, @C0185Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
            ...
            public Action(@C0185Px int i, @C0185Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0185Px int i, @C0185Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i;
        ...
        public abstract void onSeekTargetStep(@C0185Px int i, @C0185Px int i2, @NonNull State state, @NonNull Action action);
    ...
    private String getFullClassName(Context context, String str) {
        ...
        } else if (str.contains(MAPCookie.DOT)) {
            return str;
        } else {
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0844R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0844R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0844R.dimen.fastscroll_margin));
    }
    ...
    public void onScrolled(@C0185Px int i, @C0185Px int i2) {
    }
    ...
    public void smoothScrollBy(@C0185Px int i, @C0185Px int i2) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0844R.attr.recyclerViewStyle);
    }
    ...
    public void smoothScrollBy(@C0185Px int i, @C0185Px int i2, @Nullable Interpolator interpolator) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0844R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0844R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        }
        String string = obtainStyledAttributes.getString(C0844R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0844R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0844R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = obtainStyledAttributes.getBoolean(C0844R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0844R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0844R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0844R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0844R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        obtainStyledAttributes.recycle();
    ...
    public void smoothScrollBy(@C0185Px int i, @C0185Px int i2, @Nullable Interpolator interpolator, int i3) {
    ...
    public void smoothScrollBy(@C0185Px int i, @C0185Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager != null && !this.mLayoutSuppressed) {
            int i4 = 0;
