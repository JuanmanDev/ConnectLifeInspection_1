...
public final class MetadataItem extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(Table.__indirect(__element(i), this.f241bb), this.f241bb);
        }
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f247bb.getInt(__vector(__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public short compatAdded() {
        ...
        if (__offset != 0) {
            return this.f247bb.getShort(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (__offset == 0 || this.f247bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }
    ...
    public int mo8385id() {
        ...
        if (__offset != 0) {
            return this.f247bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f247bb);
        }
        return null;
    }
}
