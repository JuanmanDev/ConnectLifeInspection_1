...
import p691no.nordicsemi.android.dfu.internal.exception.DfuException;
...
public abstract class BaseCustomDfuImpl extends BaseDfuImpl {
    ...
    private void writeInitPacket(android.bluetooth.BluetoothGattCharacteristic r4, byte[] r5, int r6) {
        /*
            r3 = this;
        ...
        L_0x00b6:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p691no.nordicsemi.android.dfu.BaseCustomDfuImpl.writeInitPacket(android.bluetooth.BluetoothGattCharacteristic, byte[], int):void");
    }
    ...
    public void finalize(Intent intent, boolean z) {
        ...
        if (this.mGatt.getDevice().getBondState() == 12) {
            ...
            if (booleanExtra2 || !booleanExtra) {
                removeBond();
                this.mService.waitFor(ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS);
            }
    ...
    public void uploadFirmwareImage(android.bluetooth.BluetoothGattCharacteristic r7) {
        ...
        L_0x009d:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p691no.nordicsemi.android.dfu.BaseCustomDfuImpl.uploadFirmwareImage(android.bluetooth.BluetoothGattCharacteristic):void");
    }
