...
public class BleManager {
    ...
    public static final int DEFAULT_CONNECT_RETRY_INTERVAL = 5000;
    ...
    public long connectOverTime = 10000;
    public Application context;
    public int maxConnectCount = 7;
    public MultipleBluetoothController multipleBluetoothController;
    public int operateTimeout = 5000;
    public int reConnectCount = 0;
    public long reConnectInterval = 5000;
    public int splitWriteNum = 20;
    ...
    public void setMtu(BleDevice bleDevice, int i, BleMtuChangedCallback bleMtuChangedCallback) {
        if (bleMtuChangedCallback == null) {
            ...
            BleLog.m9697e("requiredMtu should lower than 512 !");
            bleMtuChangedCallback.onSetMTUFailure(new OtherException("requiredMtu should lower than 512 !"));
        } else if (i < 23) {
            BleLog.m9697e("requiredMtu should higher than 23 !");
    ...
    public boolean isConnected(String str) {
        for (BleDevice next : getAllConnectedDevice()) {
    ...
    public void write(BleDevice bleDevice, String str, String str2, byte[] bArr, boolean z, boolean z2, long j, BleWriteCallback bleWriteCallback) {
        ...
        if (bleWriteCallback2 == null) {
            ...
            BleLog.m9697e("data is Null!");
            bleWriteCallback2.onWriteFailure(new OtherException("data is Null!"));
        } else {
            if (bArr2.length > 20 && !z) {
                BleLog.m9699w("Be careful: data's length beyond 20! Ensure MTU higher than 23, or use spilt write!");
            }
