...
public class SplitWriter {
    public BleBluetooth mBleBluetooth;
    ...
    public String mUuid_service;
    public String mUuid_write;
    ...
    public static Queue<byte[]> splitByte(byte[] bArr, int i) {
        ...
        byte[] bArr2;
        if (i > 20) {
            BleLog.m9699w("Be careful: split count beyond 20! Ensure MTU higher than 23!");
        }
