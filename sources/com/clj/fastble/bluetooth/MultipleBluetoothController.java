...
public class MultipleBluetoothController {
    public final BleLruHashMap<String, BleBluetooth> bleLruHashMap = new BleLruHashMap<>(BleManager.getInstance().getMaxConnectCount());
    public final HashMap<String, BleBluetooth> bleTempHashMap = new HashMap<>();
    ...
    public synchronized void destroy() {
        for (Map.Entry<String, BleBluetooth> value : this.bleLruHashMap.entrySet()) {
