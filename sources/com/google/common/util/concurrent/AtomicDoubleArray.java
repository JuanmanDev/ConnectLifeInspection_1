...
public class AtomicDoubleArray implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        ImmutableLongArray.C8214c builder = ImmutableLongArray.builder();
        for (int i = 0; i < readInt; i++) {
            builder.mo37153a(Double.doubleToRawLongBits(objectInputStream.readDouble()));
        }
        this.longs = new AtomicLongArray(builder.mo37156d().toArray());
    }
