...
public class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(@NonNull View view, float f) {
        int integer = view.getResources().getInteger(C7828R.integer.app_bar_elevation_anim_duration);
        StateListAnimator stateListAnimator = new StateListAnimator();
        long j = (long) integer;
        stateListAnimator.addState(new int[]{16842766, C7828R.attr.state_liftable, -C7828R.attr.state_lifted}, ObjectAnimator.ofFloat(view, "elevation", new float[]{0.0f}).setDuration(j));
