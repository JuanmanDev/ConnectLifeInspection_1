...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i = C7828R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i, C7828R.attr.snackbarTextViewStyle};
    }
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarContentStyleAttrs(findSuitableParent.getContext()) ? C7828R.layout.mtrl_layout_snackbar_include : C7828R.layout.design_layout_snackbar_include, findSuitableParent, false);
