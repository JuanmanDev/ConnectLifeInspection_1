...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    @AttrRes
    public static final int DEF_STYLE_ATTR = C7828R.attr.alertDialogStyle;
    @StyleRes
    public static final int DEF_STYLE_RES = C7828R.style.MaterialAlertDialog_MaterialComponents;
    @AttrRes
    public static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C7828R.attr.materialAlertDialogTheme;
    @Nullable
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetBottom(@C0185Px int i) {
        this.backgroundInsets.bottom = i;
        return this;
    }

    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetEnd(@C0185Px int i) {
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetStart(@C0185Px int i) {
        if (Build.VERSION.SDK_INT < 17 || getContext().getResources().getConfiguration().getLayoutDirection() != 1) {
            this.backgroundInsets.left = i;
        } else {
            this.backgroundInsets.right = i;
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetTop(@C0185Px int i) {
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C7828R.attr.colorSurface, MaterialAlertDialogBuilder.class.getCanonicalName());
