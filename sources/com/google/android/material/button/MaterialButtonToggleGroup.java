...
public class MaterialButtonToggleGroup extends LinearLayout {
    public static final int DEF_STYLE_RES = C7828R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C7828R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.skipCheckedStateTracker = false;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C7828R.styleable.MaterialButtonToggleGroup, i, DEF_STYLE_RES, new int[0]);
        setSingleSelection(obtainStyledAttributes.getBoolean(C7828R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = obtainStyledAttributes.getResourceId(C7828R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = obtainStyledAttributes.getBoolean(C7828R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
