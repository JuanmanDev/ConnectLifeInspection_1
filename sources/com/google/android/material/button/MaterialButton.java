...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public static final int DEF_STYLE_RES = C7828R.style.Widget_MaterialComponents_Button;
    ...
    public void setCornerRadius(@C0185Px int i) {
        if (isUsingOriginalBackground()) {
    ...
    public void setIconPadding(@C0185Px int i) {
    ...
    public void setIconSize(@C0185Px int i) {
        if (i < 0) {
    ...
    public void setStrokeWidth(@C0185Px int i) {
        if (isUsingOriginalBackground()) {
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C7828R.attr.materialButtonStyle);
    }
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C7828R.styleable.MaterialButton, i, DEF_STYLE_RES, new int[0]);
        this.iconPadding = obtainStyledAttributes.getDimensionPixelSize(C7828R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C7828R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), obtainStyledAttributes, C7828R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), obtainStyledAttributes, C7828R.styleable.MaterialButton_icon);
        this.iconGravity = obtainStyledAttributes.getInteger(C7828R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = obtainStyledAttributes.getDimensionPixelSize(C7828R.styleable.MaterialButton_iconSize, 0);
