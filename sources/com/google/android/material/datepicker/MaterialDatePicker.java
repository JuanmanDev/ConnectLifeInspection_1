...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C7828R.C7830drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C7828R.C7830drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    public static int getDialogPickerHeight(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelSize = resources.getDimensionPixelSize(C7828R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C7828R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C7828R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C7828R.dimen.mtrl_calendar_days_of_week_height);
        return dimensionPixelSize + dimensionPixelSize2 + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C7828R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C7828R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C7828R.dimen.mtrl_calendar_bottom_padding);
    }

    public static int getPaddedPickerWidth(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C7828R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C7828R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C7828R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    public static boolean isFullscreen(@NonNull Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C7828R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{16843277});
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C7828R.C7831id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C7828R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void updateToggleContentDescription(@NonNull CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            str = checkableImageButton.getContext().getString(C7828R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            str = checkableImageButton.getContext().getString(C7828R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C7828R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C7828R.attr.materialCalendarStyle, C7828R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C7828R.layout.mtrl_picker_fullscreen : C7828R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C7828R.C7831id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C7828R.C7831id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C7828R.C7831id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C7828R.C7831id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C7828R.C7831id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C7828R.C7831id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C7828R.C7831id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C7828R.C7831id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C7828R.dimen.mtrl_calendar_dialog_background_inset);
