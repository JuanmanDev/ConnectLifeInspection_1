...
public class UtcDates {
    ...
    public static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll("d", resources.getString(C7828R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(C7828R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(C7828R.string.mtrl_picker_text_input_year_abbr));
    }
    ...
    public static String removeYearFromDateFormatPattern(@NonNull String str) {
        ...
        if (findCharactersInDateFormatPattern2 < str.length()) {
            str2 = str2 + RunnerArgs.CLASS_SEPARATOR;
        }
