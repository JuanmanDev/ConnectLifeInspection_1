...
public class SwitchMaterial extends SwitchCompat {
    public static final int DEF_STYLE_RES = C7828R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C7828R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C7828R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C7828R.dimen.mtrl_switch_thumb_elevation);
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C7828R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C7828R.styleable.SwitchMaterial, i, DEF_STYLE_RES, new int[0]);
        this.useMaterialThemeColors = obtainStyledAttributes.getBoolean(C7828R.styleable.SwitchMaterial_useMaterialThemeColors, false);
