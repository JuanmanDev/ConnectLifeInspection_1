...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public static final int DEF_STYLE_RES = C7828R.style.Widget_MaterialComponents_CardView;
    public static final int[] DRAGGED_STATE_SET = {C7828R.attr.state_dragged};
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C7828R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C7828R.styleable.MaterialCardView, i, DEF_STYLE_RES, new int[0]);
