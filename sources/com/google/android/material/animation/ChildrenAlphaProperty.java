...
public class ChildrenAlphaProperty extends Property<ViewGroup, Float> {
    ...
    public Float get(@NonNull ViewGroup viewGroup) {
        Float f = (Float) viewGroup.getTag(C7828R.C7831id.mtrl_internal_children_alpha_tag);
        if (f != null) {
            return f;
        }
    ...
    public void set(@NonNull ViewGroup viewGroup, @NonNull Float f) {
        ...
        viewGroup.setTag(C7828R.C7831id.mtrl_internal_children_alpha_tag, Float.valueOf(floatValue));
