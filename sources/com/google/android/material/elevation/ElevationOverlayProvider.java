...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(@NonNull Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C7828R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C7828R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C7828R.attr.colorSurface, 0);
