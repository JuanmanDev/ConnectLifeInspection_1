...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C7828R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
            this.container = frameLayout;
            BottomSheetBehavior<FrameLayout> from = BottomSheetBehavior.from((FrameLayout) frameLayout.findViewById(C7828R.C7831id.design_bottom_sheet));
            this.behavior = from;
    ...
    public static int getThemeResId(@NonNull Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C7828R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C7828R.style.Theme_Design_Light_BottomSheetDialog;
    }

    private View wrapInBottomSheet(int i, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C7828R.C7831id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout = (FrameLayout) this.container.findViewById(C7828R.C7831id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C7828R.C7831id.touch_outside).setOnClickListener(new View.OnClickListener() {
