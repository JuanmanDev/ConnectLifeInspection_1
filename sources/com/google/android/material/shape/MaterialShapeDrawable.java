...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private void drawCompatShadow(@NonNull Canvas canvas) {
        int cardinality = this.containsIncompatibleShadowOp.cardinality();
    ...
    public void setAlpha(@IntRange(from = 0, mo840to = 255) int i) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color = MaterialColors.getColor(context, C7828R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
