...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f14985y - this.startY), (double) (this.operation.f14984x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f14985y - this.startY) / (this.operation.f14984x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        /* renamed from: x */
        public float f14984x;

        /* renamed from: y */
        public float f14985y;

        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            Matrix matrix2 = this.matrix;
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f14984x, this.f14985y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f14984x = f;
        float unused2 = pathLineOperation.f14985y = f2;
