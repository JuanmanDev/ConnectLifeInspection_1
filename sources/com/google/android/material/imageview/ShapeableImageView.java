...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    public static final int DEF_STYLE_RES = C7828R.style.Widget_MaterialComponents_ShapeableImageView;
    ...
    public ShapeableImageView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C7828R.styleable.ShapeableImageView, i, DEF_STYLE_RES);
        this.strokeColor = MaterialResources.getColorStateList(context2, obtainStyledAttributes, C7828R.styleable.ShapeableImageView_strokeColor);
        this.strokeWidth = (float) obtainStyledAttributes.getDimensionPixelSize(C7828R.styleable.ShapeableImageView_strokeWidth, 0);
