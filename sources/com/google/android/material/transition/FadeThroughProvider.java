...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    public static Animator createFadeThroughAnimator(View view, float f, float f2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f3, @FloatRange(from = 0.0d, mo822to = 1.0d) float f4) {
