...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    public static Animator createTranslationAppearAnimator(View view, View view2, int i, @C0185Px int i2) {
        if (i == 3) {
    ...
    public static Animator createTranslationDisappearAnimator(View view, View view2, int i, @C0185Px int i2) {
        if (i == 3) {
    ...
    private int getSlideDistanceOrDefault(Context context) {
        ...
        return context.getResources().getDimensionPixelSize(C7828R.dimen.mtrl_transition_shared_axis_slide_distance);
    }
    ...
    public void setSlideDistance(@C0185Px int i) {
        if (i >= 0) {
