...
public class TransitionUtils {
    ...
    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f3) {
        return f + (f3 * (f2 - f));
    }

    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f3, @FloatRange(from = 0.0d, mo822to = 1.0d) float f4, @FloatRange(from = 0.0d, mo822to = 1.0d) float f5) {
        if (f5 < f3) {
            return f;
        }
    ...
    public static int lerp(int i, int i2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f, @FloatRange(from = 0.0d, mo822to = 1.0d) float f2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f3) {
        if (f3 < f) {
            return i;
        }
    ...
    public static ShapeAppearanceModel lerp(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, RectF rectF, RectF rectF2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f, @FloatRange(from = 0.0d, mo822to = 1.0d) float f2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f3) {
        if (f3 < f) {
