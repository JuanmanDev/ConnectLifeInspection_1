...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    public static Animator createFadeAnimator(View view, float f, float f2, @FloatRange(from = 0.0d, mo822to = 1.0d) float f3, @FloatRange(from = 0.0d, mo822to = 1.0d) float f4) {
