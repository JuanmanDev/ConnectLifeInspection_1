...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, mo822to = 1.0d) float f, @FloatRange(from = 0.0d, mo822to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            rectF2.set(f2 - (f5 / 2.0f), f3, f2 + (f5 / 2.0f), fitModeResult2.currentEndHeight + f3);
    ...
    public static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        } else if (transitionValues.view.getTag(C7828R.C7831id.mtrl_motion_snapshot_view) instanceof View) {
            transitionValues.view.setTag(C7828R.C7831id.mtrl_motion_snapshot_view, (Object) null);
            transitionValues.view = (View) transitionValues.view.getTag(C7828R.C7831id.mtrl_motion_snapshot_view);
        }
    ...
    public static ShapeAppearanceModel getShapeAppearance(@NonNull View view, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view.getTag(C7828R.C7831id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C7828R.C7831id.mtrl_motion_snapshot_view);
        }
    ...
    public static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(new int[]{C7828R.attr.transitionShapeAppearance});
