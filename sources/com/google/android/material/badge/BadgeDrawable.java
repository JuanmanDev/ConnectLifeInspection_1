...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    @StyleRes
    public static final int DEFAULT_STYLE = C7828R.style.Widget_MaterialComponents_Badge;
    @AttrRes
    public static final int DEFAULT_THEME_ATTR = C7828R.attr.badgeStyle;
    ...
    public BadgeDrawable(@NonNull Context context) {
        ...
        this.badgeRadius = (float) resources.getDimensionPixelSize(C7828R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = (float) resources.getDimensionPixelSize(C7828R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = (float) resources.getDimensionPixelSize(C7828R.dimen.mtrl_badge_with_text_radius);
        TextDrawableHelper textDrawableHelper2 = new TextDrawableHelper(this);
        this.textDrawableHelper = textDrawableHelper2;
        textDrawableHelper2.getTextPaint().setTextAlign(Paint.Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C7828R.style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? C7828R.dimen.mtrl_badge_text_horizontal_edge_offset : C7828R.dimen.mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        return context.getString(C7828R.string.mtrl_exceed_max_badge_number_suffix, new Object[]{Integer.valueOf(this.maxBadgeNumber), "+"});
    }

    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C7828R.styleable.Badge, i, i2, new int[0]);
        setMaxCharacterCount(obtainStyledAttributes.getInt(C7828R.styleable.Badge_maxCharacterCount, 4));
        if (obtainStyledAttributes.hasValue(C7828R.styleable.Badge_number)) {
            setNumber(obtainStyledAttributes.getInt(C7828R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, obtainStyledAttributes, C7828R.styleable.Badge_backgroundColor));
        if (obtainStyledAttributes.hasValue(C7828R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, obtainStyledAttributes, C7828R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(obtainStyledAttributes.getInt(C7828R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffset(obtainStyledAttributes.getDimensionPixelOffset(C7828R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffset(obtainStyledAttributes.getDimensionPixelOffset(C7828R.styleable.Badge_verticalOffset, 0));
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(@NonNull Context context) {
            this.badgeTextColor = new TextAppearance(context, C7828R.style.TextAppearance_MaterialComponents_Badge).textColor.getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C7828R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C7828R.plurals.mtrl_badge_content_description;
            this.contentDescriptionExceedsMaxBadgeNumberRes = C7828R.string.mtrl_exceed_max_badge_number_content_description;
        }
