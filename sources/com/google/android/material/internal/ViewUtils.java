...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i, int i2, @Nullable final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, C7828R.styleable.Insets, i, i2);
        final boolean z = obtainStyledAttributes.getBoolean(C7828R.styleable.Insets_paddingBottomSystemWindowInsets, false);
        final boolean z2 = obtainStyledAttributes.getBoolean(C7828R.styleable.Insets_paddingLeftSystemWindowInsets, false);
        final boolean z3 = obtainStyledAttributes.getBoolean(C7828R.styleable.Insets_paddingRightSystemWindowInsets, false);
    ...
    public static class RelativePadding {
        ...
        public void applyToView(View view) {
            ViewCompat.setPaddingRelative(view, this.start, this.f19512top, this.end, this.bottom);
        }

        public RelativePadding(@NonNull RelativePadding relativePadding) {
            this.start = relativePadding.start;
            this.f19512top = relativePadding.f19512top;
