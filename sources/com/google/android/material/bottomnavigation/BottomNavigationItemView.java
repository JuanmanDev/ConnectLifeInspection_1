...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setRoleDescription(getResources().getString(C7828R.string.item_view_role_description));
    }
    ...
    public BottomNavigationItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C7828R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C7828R.C7830drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C7828R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C7828R.C7831id.icon);
        this.smallLabel = (TextView) findViewById(C7828R.C7831id.smallLabel);
        this.largeLabel = (TextView) findViewById(C7828R.C7831id.largeLabel);
