...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    public static final TypeAdapterFactory DOUBLE_FACTORY = newFactory(ToNumberPolicy.DOUBLE);
    public final Gson gson;
    public final ToNumberStrategy toNumberStrategy;

    /* renamed from: com.google.gson.internal.bind.ObjectTypeAdapter$2 */
    public static /* synthetic */ class C83602 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.ObjectTypeAdapter.C83602.<clinit>():void");
        }
    }
    ...
    public static TypeAdapterFactory newFactory(final ToNumberStrategy toNumberStrategy2) {
    ...
    private Object readTerminal(JsonReader jsonReader, JsonToken jsonToken) {
        int i = C83602.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
        if (i == 3) {
    ...
    public ObjectTypeAdapter(Gson gson2, ToNumberStrategy toNumberStrategy2) {
        this.gson = gson2;
