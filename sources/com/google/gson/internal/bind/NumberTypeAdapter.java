...
public final class NumberTypeAdapter extends TypeAdapter<Number> {
    ...
    public static /* synthetic */ class C83582 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.NumberTypeAdapter.C83582.<clinit>():void");
        }
    }

    public NumberTypeAdapter(ToNumberStrategy toNumberStrategy2) {
    ...
    public static TypeAdapterFactory newFactory(ToNumberStrategy toNumberStrategy2) {
    ...
    public Number read(JsonReader jsonReader) {
        ...
        int i = C83582.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
        if (i == 1) {
            jsonReader.nextNull();
            return null;
        } else if (i == 2 || i == 3) {
