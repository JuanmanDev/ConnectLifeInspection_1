...
public final class WineCategoryViewModel$getFilterCondition$2 extends Lambda implements Function1<Throwable, Unit> {
    ...
    public WineCategoryViewModel$getFilterCondition$2(WineCategoryViewModel wineCategoryViewModel, List<String> list, List<String> list2, List<String> list3, List<String> list4) {
        super(1);
