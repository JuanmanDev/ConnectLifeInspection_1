...
public final class WineCategoryViewModel$getAllWineCategories$2 extends Lambda implements Function1<Throwable, Unit> {
    public final /* synthetic */ MutableLiveData<Pair<Boolean, List<WineCategoryInfo>>> $webViewGetWineListLiveData;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public WineCategoryViewModel$getAllWineCategories$2(MutableLiveData<Pair<Boolean, List<WineCategoryInfo>>> mutableLiveData) {
        super(1);
    ...
    public final void invoke(@Nullable Throwable th) {
        this.$webViewGetWineListLiveData.postValue(new Pair(Boolean.FALSE, CollectionsKt__CollectionsKt.emptyList()));
    }
}
