...
@DebugMetadata(mo48700c = "com.internationalwinecooler.ui.WineWebViewModel$getStatisticMonth$1", mo48701f = "WineWebViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
/* renamed from: com.internationalwinecooler.ui.WineWebViewModel$getStatisticMonth$1 */
/* compiled from: WineWebViewModel.kt */
public final class WineWebViewModel$getStatisticMonth$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WineWebViewModel$getStatisticMonth$1(String str, WineWebViewModel wineWebViewModel, String str2, String str3, String str4, double d, Continuation<? super WineWebViewModel$getStatisticMonth$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WineWebViewModel$getStatisticMonth$1(this.$auid, this.this$0, this.$startDate, this.$endDate, this.$zone, this.$defaultValue, continuation);
    }

    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((WineWebViewModel$getStatisticMonth$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (device != null) {
                ...
                C86701 r6 = new Function1<List<? extends DailyStatistic>, Unit>() {
                    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                        invoke((List<? extends DailyStatistic>) (List) obj);
                        return Unit.INSTANCE;
                    }

                    public final void invoke(@NotNull List<? extends DailyStatistic> list) {
                        String str;
                        String str2;
                        String str3;
                        ...
                        if (list.isEmpty()) {
                            ...
                            while (it.hasNext()) {
                                DailyStatistic dailyStatistic = (DailyStatistic) it.next();
                                Double humidity = dailyStatistic.getHumidity();
                                double doubleValue = humidity == null ? d : humidity.doubleValue();
                                Double temp = dailyStatistic.getTemp();
                                double doubleValue2 = temp == null ? d : temp.doubleValue();
                                Double vibration = dailyStatistic.getVibration();
                                double doubleValue3 = vibration == null ? d : vibration.doubleValue();
                                String date = dailyStatistic.getDate();
                                if (date == null) {
                                    date = "";
                                }
                                JsonObject jsonObject3 = new JsonObject();
                                Iterator<T> it2 = it;
                                jsonObject3.addProperty("date", date);
                                boolean z = true;
                                if (!(doubleValue == d)) {
                                ...
                                jsonObject4.addProperty("date", date);
                                if (!(doubleValue2 == d)) {
                                ...
                                jsonObject5.addProperty("date", date);
                                if (doubleValue3 != d) {
                                    z = false;
                                }
                                if (!z) {
                ...
                statisticService.statisticsDaily(wifiId, deviceId, str, str2, str3, r6, new Function1<Throwable, Unit>() {
                    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
