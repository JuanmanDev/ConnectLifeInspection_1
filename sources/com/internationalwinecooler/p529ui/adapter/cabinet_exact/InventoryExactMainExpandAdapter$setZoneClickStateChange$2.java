...
/* renamed from: com.internationalwinecooler.ui.adapter.cabinet_exact.InventoryExactMainExpandAdapter$setZoneClickStateChange$2 */
/* compiled from: InventoryExactMainExpandAdapter.kt */
public final class InventoryExactMainExpandAdapter$setZoneClickStateChange$2 extends Lambda implements Function1<View, Unit> {
    public final /* synthetic */ BaseViewHolder $holder;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InventoryExactMainExpandAdapter$setZoneClickStateChange$2(BaseViewHolder baseViewHolder) {
        super(1);
    ...
    public final void invoke(@Nullable View view) {
        ...
        ((TextView) this.$holder.itemView.findViewById(R$id.zone_a_text)).setBackgroundResource(R.drawable.inventory_shelf_a_normal);
        ((TextView) this.$holder.itemView.findViewById(R$id.zone_b_text)).setBackgroundResource(R.drawable.inventory_shelf_b_select);
        ((TextView) this.$holder.itemView.findViewById(R$id.zone_c_text)).setBackgroundResource(R.drawable.inventory_shelf_c_normal);
        ((TextView) this.$holder.itemView.findViewById(R$id.zone_a_text)).setTextColor(C1499f.m915a(R.color.colorBlack));
        ((TextView) this.$holder.itemView.findViewById(R$id.zone_b_text)).setTextColor(C1499f.m915a(R.color.colorWhite));
