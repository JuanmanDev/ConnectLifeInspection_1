...
/* renamed from: com.internationalwinecooler.ui.adapter.cabinet_exact.InventoryExactMainExpandAdapter$setZoneClickStateChange$3 */
/* compiled from: InventoryExactMainExpandAdapter.kt */
public final class InventoryExactMainExpandAdapter$setZoneClickStateChange$3 extends Lambda implements Function1<View, Unit> {
    public final /* synthetic */ BaseViewHolder $holder;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InventoryExactMainExpandAdapter$setZoneClickStateChange$3(BaseViewHolder baseViewHolder) {
        super(1);
    ...
    public final void invoke(@Nullable View view) {
        ...
        ((TextView) this.$holder.itemView.findViewById(R$id.zone_c_text)).setBackgroundResource(R.drawable.inventory_shelf_c_select);
        ...
        ((TextView) this.$holder.itemView.findViewById(R$id.zone_c_text)).setTextColor(C1499f.m915a(R.color.colorWhite));
    }
}
