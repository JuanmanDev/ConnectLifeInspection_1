...
@DebugMetadata(mo48700c = "com.internationalwinecooler.ui.WineWebViewModel$getWineCoolerList$1", mo48701f = "WineWebViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
/* renamed from: com.internationalwinecooler.ui.WineWebViewModel$getWineCoolerList$1 */
/* compiled from: WineWebViewModel.kt */
public final class WineWebViewModel$getWineCoolerList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ WineWebViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public WineWebViewModel$getWineCoolerList$1(WineWebViewModel wineWebViewModel, Continuation<? super WineWebViewModel$getWineCoolerList$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WineWebViewModel$getWineCoolerList$1(this.this$0, continuation);
    }

    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((WineWebViewModel$getWineCoolerList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            LoggerUtil.Companion.mo39146e(Intrinsics.stringPlus("jsResp: ", jsonObject));
            wineWebViewModel.getEvaluateJsLiveData().postValue(new Pair(WebActionEnum.GET_WINE_COOLER_LIST_CALLBACK, jsonObject.toString()));
