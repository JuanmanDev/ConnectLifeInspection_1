...
@DebugMetadata(mo48700c = "com.internationalwinecooler.ui.WineWebViewModel$getStatisticWeek$1", mo48701f = "WineWebViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
/* renamed from: com.internationalwinecooler.ui.WineWebViewModel$getStatisticWeek$1 */
/* compiled from: WineWebViewModel.kt */
public final class WineWebViewModel$getStatisticWeek$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WineWebViewModel$getStatisticWeek$1(String str, WineWebViewModel wineWebViewModel, String str2, String str3, String str4, double d, Continuation<? super WineWebViewModel$getStatisticWeek$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WineWebViewModel$getStatisticWeek$1(this.$auid, this.this$0, this.$startDate, this.$endDate, this.$zone, this.$defaultValue, continuation);
    }

    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((WineWebViewModel$getStatisticWeek$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (device != null) {
                ...
                C86721 r6 = new Function1<List<? extends DailyStatistic>, Unit>() {
