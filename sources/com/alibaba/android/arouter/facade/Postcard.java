...
public final class Postcard extends RouteMeta {
    ...
    public Postcard withObject(@Nullable String str, @Nullable Object obj) {
        SerializationService serializationService2 = (SerializationService) C1337a.m211c().mo15014g(SerializationService.class);
    ...
    public Object navigation(Context context, NavigationCallback navigationCallback) {
        return C1337a.m211c().mo15013f(context, this, -1, navigationCallback);
    }
    ...
    public void navigation(Activity activity, int i, NavigationCallback navigationCallback) {
        C1337a.m211c().mo15013f(activity, this, i, navigationCallback);
    }
}
