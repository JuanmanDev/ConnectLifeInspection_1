...
public final class DeviceViewModel$devicePropertyLiveData$2 extends Lambda implements Function0<MutableLiveData<List<? extends DevicePropertyBean>>> {
    public static final DeviceViewModel$devicePropertyLiveData$2 INSTANCE = new DeviceViewModel$devicePropertyLiveData$2();

    public DeviceViewModel$devicePropertyLiveData$2() {
        super(0);
    }
