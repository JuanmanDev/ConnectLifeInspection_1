...
public final class DashBoardFragment$msgObserverViewModel$2 extends Lambda implements Function0<MsgObserverViewModel> {
    public final /* synthetic */ DashBoardFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DashBoardFragment$msgObserverViewModel$2(DashBoardFragment dashBoardFragment) {
        super(0);
    ...
    public final MsgObserverViewModel invoke() {
        ViewModel viewModel = ViewModelProviders.m95of((Fragment) this.this$0).get(MsgObserverViewModel.class);
