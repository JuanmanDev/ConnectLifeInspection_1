...
public final class TicketsBaseFragment$refreshData$$inlined$sortBy$2<T> implements Comparator {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((TicketBean) t).getDateOfRepair(), ((TicketBean) t2).getDateOfRepair());
    }
}
