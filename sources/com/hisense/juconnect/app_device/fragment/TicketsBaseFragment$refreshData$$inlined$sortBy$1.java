...
public final class TicketsBaseFragment$refreshData$$inlined$sortBy$1<T> implements Comparator {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((TicketBean) t).getDateOfClaim(), ((TicketBean) t2).getDateOfClaim());
    }
}
