...
public final class AddApplianceFirstActivity extends BaseActivity {
    ...
    public final void gotoBindDevice() {
    ...
    public int bindLayout() {
        return R$layout.activity_add_appliance_first;
    }
    ...
    public void setListeners() {
        ...
        JuConnectExtKt.singleClickListener(iconFontView, new AddApplianceFirstActivity$setListeners$1(this));
        CardView cardView = (CardView) _$_findCachedViewById(R$id.device_type_three);
        Intrinsics.checkNotNullExpressionValue(cardView, "device_type_three");
        JuConnectExtKt.singleClickListener(cardView, new AddApplianceFirstActivity$setListeners$2(this));
        CardView cardView2 = (CardView) _$_findCachedViewById(R$id.device_type_one);
        Intrinsics.checkNotNullExpressionValue(cardView2, "device_type_one");
        JuConnectExtKt.singleClickListener(cardView2, new AddApplianceFirstActivity$setListeners$3(this));
        CardView cardView3 = (CardView) _$_findCachedViewById(R$id.device_type_off_stage);
        Intrinsics.checkNotNullExpressionValue(cardView3, "device_type_off_stage");
        JuConnectExtKt.singleClickListener(cardView3, new AddApplianceFirstActivity$setListeners$4(this));
    }
}
