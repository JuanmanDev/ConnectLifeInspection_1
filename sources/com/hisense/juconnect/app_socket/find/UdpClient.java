...
@Metadata(mo47990d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B!\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007¢\u0006\u0002\u0010\bJ\u0006\u0010\u0010\u001a\u00020\u0011J\b\u0010\u0012\u001a\u00020\u0011H\u0002J\u0006\u0010\u0013\u001a\u00020\u0011J\u0010\u0010\u0014\u001a\u00020\u00112\u0006\u0010\u0015\u001a\u00020\u0016H\u0002J\u0010\u0010\u0017\u001a\u00020\u00112\u0006\u0010\u0015\u001a\u00020\u0016H\u0002J\u0006\u0010\u0018\u001a\u00020\u0011R\u000e\u0010\t\u001a\u00020\nX\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00060\fR\u00020\u0005X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX.¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u000eX.¢\u0006\u0002\n\u0000¨\u0006\u0019"}, mo47991d2 = {"Lcom/hisense/juconnect/app_socket/find/UdpClient;", "", "context", "Landroid/content/Context;", "manager", "Landroid/net/wifi/WifiManager;", "callBack", "Lcom/hisense/juconnect/app_socket/find/FindCallBack;", "(Landroid/content/Context;Landroid/net/wifi/WifiManager;Lcom/hisense/juconnect/app_socket/find/FindCallBack;)V", "aesUtils", "Lcom/hisense/juconnect/app_socket/utils/AesUtils2;", "lock", "Landroid/net/wifi/WifiManager$MulticastLock;", "udpReceiveBroadcaster", "Lcom/hisense/juconnect/app_socket/find/UDPBroadcaster;", "udpSendBroadcaster", "close", "", "init", "listen", "onListenError", "e", "Ljava/lang/Exception;", "onSendError", "send", "app_socket_release"}, mo47992k = 1, mo47993mv = {1, 6, 0}, mo47995xi = 48)
...
public final class UdpClient {
    ...
    public final void listen() {
        /*
            ...
            r1 = 0
            com.hisense.juconnect.app_socket.find.UDPBroadcaster r2 = r6.udpReceiveBroadcaster     // Catch:{ UnknownHostException -> 0x0093, SocketException -> 0x0085, IOException -> 0x0077, Exception -> 0x0061 }
        ...
        L_0x000b:
            ...
            r4 = 2
            r5 = 0
            com.hisense.juconnect.app_socket.find.UDPBroadcaster.open$default(r2, r3, r5, r4, r1)     // Catch:{ UnknownHostException -> 0x0093, SocketException -> 0x0085, IOException -> 0x0077, Exception -> 0x0061 }
            ...
            com.hisense.juconnect.app_socket.find.UDPBroadcaster r3 = r6.udpReceiveBroadcaster     // Catch:{ UnknownHostException -> 0x0093, SocketException -> 0x0085, IOException -> 0x0077, Exception -> 0x0061 }
        ...
        L_0x0023:
            ...
            com.hisense.juconnect.app_socket.utils.AesUtils2 r4 = r6.aesUtils     // Catch:{ UnknownHostException -> 0x0093, SocketException -> 0x0085, IOException -> 0x0077, Exception -> 0x0061 }
        ...
        L_0x0032:
            ...
            java.lang.Class<com.hisense.juconnect.app_socket.find.BcWifiMessage> r4 = com.hisense.juconnect.app_socket.find.BcWifiMessage.class
            java.lang.Object r2 = r3.fromJson((java.lang.String) r2, r4)     // Catch:{ Exception -> 0x004f }
            com.hisense.juconnect.app_socket.find.BcWifiMessage r2 = (com.hisense.juconnect.app_socket.find.BcWifiMessage) r2     // Catch:{ Exception -> 0x004f }
            com.hisense.juconnect.app_socket.find.FindCallBack r3 = r6.callBack     // Catch:{ Exception -> 0x004f }
        ...
        L_0x0055:
            ...
            r2.release()
            com.hisense.juconnect.app_socket.find.UDPBroadcaster r2 = r6.udpReceiveBroadcaster
        ...
        L_0x00a2:
            ...
            r3.release()
            com.hisense.juconnect.app_socket.find.UDPBroadcaster r3 = r6.udpReceiveBroadcaster
        ...
        L_0x00b0:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hisense.juconnect.app_socket.find.UdpClient.listen():void");
    }
    ...
    public final void send() {
        /*
            r6 = this;
            com.hisense.juconnect.app_socket.find.UDPBroadcaster r0 = r6.udpSendBroadcaster
        ...
        L_0x000b:
            ...
            r5 = 1
            com.hisense.juconnect.app_socket.find.UDPBroadcaster.open$default(r0, r3, r4, r5, r2)
            com.hisense.juconnect.app_socket.find.BCPhoneMsg r0 = new com.hisense.juconnect.app_socket.find.BCPhoneMsg
            r0.<init>()
            java.lang.String r0 = r0.toJson()
            com.hisense.juconnect.app_socket.utils.AesUtils2 r3 = r6.aesUtils
        ...
        L_0x0030:
            ...
            goto L_0x0046
        L_0x0033:
            com.hisense.juconnect.app_socket.find.UDPBroadcaster r4 = r6.udpSendBroadcaster     // Catch:{ UnknownHostException -> 0x0070, SocketException -> 0x0067, IOException -> 0x005e, Exception -> 0x0055 }
        ...
        L_0x003b:
            ...
            com.hisense.juconnect.app_socket.find.FindCallBack r3 = r6.callBack     // Catch:{ UnknownHostException -> 0x0070, SocketException -> 0x0067, IOException -> 0x005e, Exception -> 0x0055 }
        ...
        L_0x0079:
            return
        L_0x007a:
            com.hisense.juconnect.app_socket.find.UDPBroadcaster r3 = r6.udpSendBroadcaster
        ...
        L_0x0083:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hisense.juconnect.app_socket.find.UdpClient.send():void");
    }
}
