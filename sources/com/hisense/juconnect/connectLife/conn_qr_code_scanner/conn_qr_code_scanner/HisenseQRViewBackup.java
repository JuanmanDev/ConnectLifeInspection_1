...
import p307cn.bingoogolapple.qrcode.zxing.ZXingView;
...
@Metadata(mo47990d1 = {"\u0000v\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0004\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u00032\u00020\u0004B9\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b\u0012\"\u0010\t\u001a\u001e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\nj\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f`\r¢\u0006\u0002\u0010\u000eJ\u0012\u0010\u0016\u001a\u00020\u00172\b\u0010\u0018\u001a\u0004\u0018\u00010\u0019H\u0002J\b\u0010\u001a\u001a\u00020\u0017H\u0016J\b\u0010\u001b\u001a\u00020\u001cH\u0016J\b\u0010\u001d\u001a\u00020\u0014H\u0002J\n\u0010\u001e\u001a\u0004\u0018\u00010\u0010H\u0002J\u0010\u0010\u001f\u001a\u00020\u00172\u0006\u0010 \u001a\u00020\u0014H\u0016J\u0018\u0010!\u001a\u00020\u00172\u0006\u0010\"\u001a\u00020#2\u0006\u0010\u0018\u001a\u00020\u0019H\u0016J/\u0010$\u001a\u00020\u00142\u0006\u0010%\u001a\u00020\b2\u0010\u0010&\u001a\f\u0012\u0006\b\u0001\u0012\u00020\u000b\u0018\u00010'2\u0006\u0010(\u001a\u00020)H\u0016¢\u0006\u0002\u0010*J\b\u0010+\u001a\u00020\u0017H\u0016J\u0012\u0010,\u001a\u00020\u00172\b\u0010\u0018\u001a\u0004\u0018\u00010\u000bH\u0016R\u0010\u0010\u000f\u001a\u0004\u0018\u00010\u0010X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0012X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0014X\u000e¢\u0006\u0002\n\u0000R*\u0010\t\u001a\u001e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\nj\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f`\rX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0014X\u000e¢\u0006\u0002\n\u0000¨\u0006-"}, mo47991d2 = {"Lcom/hisense/juconnect/connectLife/conn_qr_code_scanner/conn_qr_code_scanner/HisenseQRViewBackup;", "Lio/flutter/plugin/platform/PlatformView;", "Lio/flutter/plugin/common/MethodChannel$MethodCallHandler;", "Lio/flutter/plugin/common/PluginRegistry$RequestPermissionsResultListener;", "Lcn/bingoogolapple/qrcode/core/QRCodeView$Delegate;", "messenger", "Lio/flutter/plugin/common/BinaryMessenger;", "id", "", "params", "Ljava/util/HashMap;", "", "", "Lkotlin/collections/HashMap;", "(Lio/flutter/plugin/common/BinaryMessenger;ILjava/util/HashMap;)V", "barcodeView", "Lcn/bingoogolapple/qrcode/zxing/ZXingView;", "channel", "Lio/flutter/plugin/common/MethodChannel;", "isTorchOn", "", "permissionGranted", "checkAndRequestPermission", "", "result", "Lio/flutter/plugin/common/MethodChannel$Result;", "dispose", "getView", "Landroid/view/View;", "hasCameraPermission", "initBarCodeView", "onCameraAmbientBrightnessChanged", "isDark", "onMethodCall", "call", "Lio/flutter/plugin/common/MethodCall;", "onRequestPermissionsResult", "requestCode", "permissions", "", "grantResults", "", "(I[Ljava/lang/String;[I)Z", "onScanQRCodeOpenCameraError", "onScanQRCodeSuccess", "conn_qr_code_scanner_release"}, mo47992k = 1, mo47993mv = {1, 6, 0}, mo47995xi = 48)
/* compiled from: HisenseQRViewBackup.kt */
public final class HisenseQRViewBackup implements C9055e, C9017j.C9021c, C9024l.C9028d, QRCodeView.C3734f {
    @Nullable
    public ZXingView barcodeView;
    @NotNull
    ...
    public HisenseQRViewBackup(@NotNull C9003c cVar, int i, @NotNull HashMap<String, Object> hashMap) {
        ...
        if (activity != null && (application = activity.getApplication()) != null) {
            application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks(this) {
                public final /* synthetic */ HisenseQRViewBackup this$0;
                ...
                public void onActivityPaused(@NotNull Activity activity) {
                    ZXingView access$getBarcodeView$p;
                    Intrinsics.checkNotNullParameter(activity, "p0");
                    if (Intrinsics.areEqual((Object) activity, (Object) Shared.INSTANCE.getActivity()) && this.this$0.hasCameraPermission() && (access$getBarcodeView$p = this.this$0.barcodeView) != null) {
                        access$getBarcodeView$p.mo21130y();
                    }
                }
                ...
                public void onActivityResumed(@NotNull Activity activity) {
                    ...
                    Intrinsics.checkNotNullParameter(activity, "p0");
                    if (Intrinsics.areEqual((Object) activity, (Object) Shared.INSTANCE.getActivity()) && this.this$0.hasCameraPermission() && (access$getBarcodeView$p = this.this$0.barcodeView) != null) {
                        access$getBarcodeView$p.mo21128w();
                    }
                }
    ...
    private final ZXingView initBarCodeView() {
        if (this.barcodeView == null) {
            View inflate = LayoutInflater.from(Shared.INSTANCE.getActivity()).inflate(R$layout.scan_view, (ViewGroup) null);
            if (inflate != null) {
                this.barcodeView = (ZXingView) inflate;
            } else {
                throw new NullPointerException("null cannot be cast to non-null type cn.bingoogolapple.qrcode.zxing.ZXingView");
            }
        } else if (!hasCameraPermission()) {
            checkAndRequestPermission((C9017j.C9022d) null);
        }
        ZXingView zXingView = this.barcodeView;
        if (zXingView == null) {
            return null;
        }
    ...
    public void dispose() {
        ...
        ZXingView zXingView2 = this.barcodeView;
        if (zXingView2 != null) {
            zXingView2.mo21129x();
        }
    ...
    @NotNull
    public View getView() {
        ZXingView initBarCodeView = initBarCodeView();
            ...
            switch (str.hashCode()) {
                ...
                case -1824838201:
                    if (str.equals("stopCamera")) {
                        ...
                        ZXingView zXingView3 = this.barcodeView;
                        if (zXingView3 != null) {
                            zXingView3.mo21129x();
                        }
                        ZXingView zXingView4 = this.barcodeView;
                        if (zXingView4 != null) {
                            zXingView4.mo21131z();
                        }
                        dVar.success((Object) null);
                ...
                case -668845828:
                    if (str.equals("toggleFlash")) {
                        ...
                        this.isTorchOn = z;
                        if (z) {
                            ZXingView zXingView5 = this.barcodeView;
                            if (zXingView5 != null) {
                                zXingView5.mo21116n();
                            }
                        } else {
                            ZXingView zXingView6 = this.barcodeView;
                            if (zXingView6 != null) {
                                zXingView6.mo21101c();
                            }
                        }
                ...
                case 1026482610:
                    if (str.equals("resumeCamera")) {
                        ZXingView zXingView7 = this.barcodeView;
                        if (zXingView7 != null) {
                            zXingView7.mo21128w();
                        }
                        dVar.success((Object) null);
                ...
                case 1714778527:
                    if (str.equals("stopScan")) {
                        ZXingView zXingView8 = this.barcodeView;
                        if (zXingView8 != null) {
                            zXingView8.mo21130y();
                        }
                        dVar.success((Object) null);
                ...
                case 2013529275:
                    if (str.equals("pauseCamera")) {
                        ZXingView zXingView9 = this.barcodeView;
                        if (zXingView9 != null) {
                            zXingView9.mo21130y();
                        }
                        dVar.success((Object) null);
