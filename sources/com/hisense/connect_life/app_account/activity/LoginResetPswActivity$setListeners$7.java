...
public final class LoginResetPswActivity$setListeners$7 extends Lambda implements Function1<View, Unit> {
    public final /* synthetic */ LoginResetPswActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LoginResetPswActivity$setListeners$7(LoginResetPswActivity loginResetPswActivity) {
        super(1);
    ...
    public final void invoke(@Nullable View view) {
        ...
        EditText editText = (EditText) loginResetPswActivity._$_findCachedViewById(R$id.sign_password);
