...
/* renamed from: com.hisense.connect_life.app_account.activity.RegisterInputEmaliActiviy$setListeners$$inlined$doAfterTextChanged$3 */
/* compiled from: TextView.kt */
public final class C8455x9cabadbf implements TextWatcher {
    public final /* synthetic */ RegisterInputEmaliActiviy this$0;

    public C8455x9cabadbf(RegisterInputEmaliActiviy registerInputEmaliActiviy) {
        this.this$0 = registerInputEmaliActiviy;
    }

    public void afterTextChanged(@Nullable Editable editable) {
        RegisterInputEmaliActiviy registerInputEmaliActiviy = this.this$0;
        if (!registerInputEmaliActiviy.checkPasswordFormat(((EditText) registerInputEmaliActiviy._$_findCachedViewById(R$id.sign_repeat_password)).getText().toString())) {
