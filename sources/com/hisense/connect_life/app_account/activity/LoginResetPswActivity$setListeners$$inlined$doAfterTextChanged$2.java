...
public final class LoginResetPswActivity$setListeners$$inlined$doAfterTextChanged$2 implements TextWatcher {
    public final /* synthetic */ LoginResetPswActivity this$0;

    public LoginResetPswActivity$setListeners$$inlined$doAfterTextChanged$2(LoginResetPswActivity loginResetPswActivity) {
        this.this$0 = loginResetPswActivity;
    }

    public void afterTextChanged(@Nullable Editable editable) {
        LoginResetPswActivity loginResetPswActivity = this.this$0;
        if (!loginResetPswActivity.checkPasswordFormat(((EditText) loginResetPswActivity._$_findCachedViewById(R$id.sign_password)).getText().toString())) {
