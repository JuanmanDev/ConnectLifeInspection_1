...
public final class RegisterInputEmaliActiviy$setListeners$3 extends Lambda implements Function1<View, Unit> {
    public final /* synthetic */ RegisterInputEmaliActiviy this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RegisterInputEmaliActiviy$setListeners$3(RegisterInputEmaliActiviy registerInputEmaliActiviy) {
        super(1);
    ...
    public final void invoke(@Nullable View view) {
        ...
        EditText editText = (EditText) registerInputEmaliActiviy._$_findCachedViewById(R$id.sign_password);
