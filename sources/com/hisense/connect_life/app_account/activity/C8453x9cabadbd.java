...
/* renamed from: com.hisense.connect_life.app_account.activity.RegisterInputEmaliActiviy$setListeners$$inlined$doAfterTextChanged$1 */
/* compiled from: TextView.kt */
public final class C8453x9cabadbd implements TextWatcher {
    public final /* synthetic */ RegisterInputEmaliActiviy this$0;

    public C8453x9cabadbd(RegisterInputEmaliActiviy registerInputEmaliActiviy) {
    ...
    public void afterTextChanged(@Nullable Editable editable) {
        ...
        registerInputEmaliActiviy.showEmailError(!registerInputEmaliActiviy.checkEmailFormat(), string);
