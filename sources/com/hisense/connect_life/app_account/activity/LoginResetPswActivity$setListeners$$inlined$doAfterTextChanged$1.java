...
public final class LoginResetPswActivity$setListeners$$inlined$doAfterTextChanged$1 implements TextWatcher {
    public final /* synthetic */ LoginResetPswActivity this$0;

    public LoginResetPswActivity$setListeners$$inlined$doAfterTextChanged$1(LoginResetPswActivity loginResetPswActivity) {
        this.this$0 = loginResetPswActivity;
    }

    public void afterTextChanged(@Nullable Editable editable) {
        LoginResetPswActivity loginResetPswActivity = this.this$0;
        loginResetPswActivity.showCodeError(!loginResetPswActivity.checkCode(), "");
