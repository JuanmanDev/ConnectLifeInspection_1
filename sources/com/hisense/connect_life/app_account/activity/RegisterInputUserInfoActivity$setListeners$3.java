...
public final class RegisterInputUserInfoActivity$setListeners$3 extends Lambda implements Function1<View, Unit> {
    public final /* synthetic */ RegisterInputUserInfoActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RegisterInputUserInfoActivity$setListeners$3(RegisterInputUserInfoActivity registerInputUserInfoActivity) {
        super(1);
    ...
    public final void invoke(@Nullable View view) {
        ...
        multiLanguageDialog.setCurrentItem(this.this$0.languageCurrentItem);
    }
}
