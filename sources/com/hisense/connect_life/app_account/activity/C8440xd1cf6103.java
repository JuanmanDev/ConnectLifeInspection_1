...
/* renamed from: com.hisense.connect_life.app_account.activity.ChangePasswordActivity$setListeners$$inlined$doAfterTextChanged$1 */
/* compiled from: TextView.kt */
public final class C8440xd1cf6103 implements TextWatcher {
    public final /* synthetic */ ChangePasswordActivity this$0;

    public C8440xd1cf6103(ChangePasswordActivity changePasswordActivity) {
    ...
    public void afterTextChanged(@Nullable Editable editable) {
        ...
        TextView textView = (TextView) this.this$0._$_findCachedViewById(R$id.tv_error_old_password);
        ...
        changePasswordActivity.showPasswordError(!changePasswordActivity.checkPasswordFormat(((EditText) changePasswordActivity._$_findCachedViewById(R$id.sign_old_password)).getText().toString()), string, textView, linearLayout);
