...
/* renamed from: com.hisense.connect_life.app_account.activity.ChangePasswordActivity$setListeners$$inlined$doAfterTextChanged$3 */
/* compiled from: TextView.kt */
public final class C8442xd1cf6105 implements TextWatcher {
    public final /* synthetic */ ChangePasswordActivity this$0;

    public C8442xd1cf6105(ChangePasswordActivity changePasswordActivity) {
        this.this$0 = changePasswordActivity;
    }

    public void afterTextChanged(@Nullable Editable editable) {
        ChangePasswordActivity changePasswordActivity = this.this$0;
        if (!changePasswordActivity.checkPasswordFormat(((EditText) changePasswordActivity._$_findCachedViewById(R$id.sign_repeat_password)).getText().toString())) {
            ...
            if (!(((EditText) this.this$0._$_findCachedViewById(R$id.sign_new_password)).getText().toString().length() > 0) || this.this$0.checkPasswordSame()) {
