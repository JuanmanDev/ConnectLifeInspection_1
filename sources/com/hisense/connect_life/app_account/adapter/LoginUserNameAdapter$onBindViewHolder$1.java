...
public final class LoginUserNameAdapter$onBindViewHolder$1 extends Lambda implements Function1<View, Unit> {
    public final /* synthetic */ int $position;
    public final /* synthetic */ LoginUserNameAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LoginUserNameAdapter$onBindViewHolder$1(LoginUserNameAdapter loginUserNameAdapter, int i) {
        super(1);
    ...
    public final void invoke(@Nullable View view) {
        ...
        if (access$getOnItemClickListener$p != null) {
            access$getOnItemClickListener$p.onItemClick(this.$position, this.this$0.getLoginUserInfoList().get(this.$position), this.this$0.userBgArray[this.$position].intValue());
        }
    }
}
