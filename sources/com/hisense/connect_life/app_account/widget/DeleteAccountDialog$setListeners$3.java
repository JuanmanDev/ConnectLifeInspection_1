...
public final class DeleteAccountDialog$setListeners$3 extends Lambda implements Function1<View, Unit> {
    public final /* synthetic */ DeleteAccountDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DeleteAccountDialog$setListeners$3(DeleteAccountDialog deleteAccountDialog) {
        super(1);
    ...
    public final void invoke(@Nullable View view) {
        ...
        if (access$getIItemCallback$p != null) {
            access$getIItemCallback$p.accept(((EditText) this.this$0._$_findCachedViewById(R$id.sign_password)).getText().toString());
        }
        this.this$0.dismiss();
    }
}
