...
@DebugMetadata(mo48700c = "com.hisense.connect_life.app_account.viewmodel.AccountViewModel$resetPassword$1", mo48701f = "AccountViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
/* compiled from: AccountViewModel.kt */
public final class AccountViewModel$resetPassword$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AccountViewModel$resetPassword$1(String str, String str2, String str3, AccountViewModel accountViewModel, Continuation<? super AccountViewModel$resetPassword$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountViewModel$resetPassword$1(this.$loginName, this.$authCode, this.$newPassword, this.this$0, continuation);
    }

    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((AccountViewModel$resetPassword$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            accountService.resetPassword(str, str2, str3, anonymousLoginToken, new Function1<HiSmartCallback<Boolean>, Unit>() {
                ...
                public final void invoke(@NotNull HiSmartCallback<Boolean> hiSmartCallback) {
                    Intrinsics.checkNotNullParameter(hiSmartCallback, "$this$resetPassword");
                    ...
                    hiSmartCallback.success(new Function1<Boolean, Unit>() {
                        ...
                        public final void invoke(boolean z) {
                            ...
                            accountViewModel.getResetPswLiveData().postValue(new Pair(Boolean.valueOf(z), 0));
                        }
                    });
                    ...
                    hiSmartCallback.failure(new Function1<FailureBean, Unit>() {
                        ...
                        public final void invoke(@NotNull FailureBean failureBean) {
                            ...
                            accountViewModel2.getResetPswLiveData().postValue(new Pair(Boolean.FALSE, Integer.valueOf(failureBean.getErrorCode())));
                        }
                    });
                }
            });
