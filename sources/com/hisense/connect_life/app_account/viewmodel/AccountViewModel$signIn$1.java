...
@DebugMetadata(mo48700c = "com.hisense.connect_life.app_account.viewmodel.AccountViewModel$signIn$1", mo48701f = "AccountViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
/* compiled from: AccountViewModel.kt */
public final class AccountViewModel$signIn$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AccountViewModel$signIn$1(String str, String str2, String str3, AccountViewModel accountViewModel, Continuation<? super AccountViewModel$signIn$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountViewModel$signIn$1(this.$email, this.$password, this.$authCode, this.this$0, continuation);
    }

    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((AccountViewModel$signIn$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            accountService.login(str, str2, str3, jhlDevSerial, anonymousLoginToken, new Function1<HiSmartCallback<ClientLoginInfo>, Unit>() {
                ...
                public final void invoke(@NotNull HiSmartCallback<ClientLoginInfo> hiSmartCallback) {
                    ...
                    final String str2 = str5;
                    hiSmartCallback.success(new Function1<ClientLoginInfo, Unit>() {

                        @Metadata(mo47990d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H@"}, mo47991d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, mo47992k = 3, mo47993mv = {1, 6, 0}, mo47995xi = 48)
                        @DebugMetadata(mo48700c = "com.hisense.connect_life.app_account.viewmodel.AccountViewModel$signIn$1$1$1$1", mo48701f = "AccountViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
                        /* renamed from: com.hisense.connect_life.app_account.viewmodel.AccountViewModel$signIn$1$1$1$1 */
                        /* compiled from: AccountViewModel.kt */
                        public static final class C85341 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            public int label;

                            @NotNull
                            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                                return new C85341(accountViewModel, clientLoginInfo2, str, str2, continuation);
                            }

                            @Nullable
                            public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
                                return ((C85341) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
                            }
                            ...
                            public final Object invokeSuspend(@NotNull Object obj) {
                                ...
                                if (this.label == 0) {
                                    ResultKt.throwOnFailure(obj);
                                    accountViewModel.setLoginSuccInfo(clientLoginInfo2, str, str2, "0", "");
                        ...
                        public final void invoke(@NotNull ClientLoginInfo clientLoginInfo) {
                            ...
                            final ClientLoginInfo clientLoginInfo2 = clientLoginInfo;
                            Job unused = BuildersKt__Builders_commonKt.launch$default(viewModelScope, main, (CoroutineStart) null, new C85341((Continuation<? super C85341>) null), 2, (Object) null);
                        }
                    });
