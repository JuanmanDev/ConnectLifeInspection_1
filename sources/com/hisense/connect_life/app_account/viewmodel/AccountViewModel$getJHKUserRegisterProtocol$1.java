...
@DebugMetadata(mo48700c = "com.hisense.connect_life.app_account.viewmodel.AccountViewModel$getJHKUserRegisterProtocol$1", mo48701f = "AccountViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
/* compiled from: AccountViewModel.kt */
public final class AccountViewModel$getJHKUserRegisterProtocol$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public final /* synthetic */ String $requestType;
    public int label;
    public final /* synthetic */ AccountViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AccountViewModel$getJHKUserRegisterProtocol$1(String str, AccountViewModel accountViewModel, Continuation<? super AccountViewModel$getJHKUserRegisterProtocol$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AccountViewModel$getJHKUserRegisterProtocol$1(this.$requestType, this.this$0, continuation);
    }

    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((AccountViewModel$getJHKUserRegisterProtocol$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            accountService.getJHKUserRegisterProtocol(anonymousLoginToken, str, new Function1<HiSmartCallback<JHKUserAgreementBean>, Unit>() {
                ...
                public final void invoke(@NotNull HiSmartCallback<JHKUserAgreementBean> hiSmartCallback) {
                    Intrinsics.checkNotNullParameter(hiSmartCallback, "$this$getJHKUserRegisterProtocol");
                    ...
                    hiSmartCallback.success(new Function1<JHKUserAgreementBean, Unit>() {
                        ...
                        public final void invoke(@NotNull JHKUserAgreementBean jHKUserAgreementBean) {
                            ...
                            accountViewModel.getGetJHKUserRegisterProtocolLiveData().postValue(new Pair(Boolean.TRUE, jHKUserAgreementBean));
                        }
                    });
                    ...
                    hiSmartCallback.failure(new Function1<FailureBean, Unit>() {
                        ...
                        public final void invoke(@NotNull FailureBean failureBean) {
                            ...
                            accountViewModel2.getGetJHKUserRegisterProtocolLiveData().postValue(new Pair(Boolean.FALSE, null));
                        }
                    });
                }
            });
