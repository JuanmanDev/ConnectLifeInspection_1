...
@DebugMetadata(mo48700c = "com.hisense.connect_life.app_account.viewmodel.ConfigViewModel$cfgPars$1", mo48701f = "ConfigViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
                ...
                public final void invoke(@NotNull HiSmartCallback<ConfigParsCom> hiSmartCallback) {
                    ...
                    hiSmartCallback.success(new Function1<ConfigParsCom, Unit>() {
                        ...
                        public final void invoke(@NotNull ConfigParsCom configParsCom) {
                            ...
                            configViewModel.writeLogToFile("配网成功");
                    ...
                    hiSmartCallback.failure(new Function1<FailureBean, Unit>() {
                        ...
                        public final void invoke(@NotNull FailureBean failureBean) {
                            ...
                            configViewModel2.writeLogToFile(Intrinsics.stringPlus("配网失败：", failureBean.getErrorDesc()));
                            configViewModel2.getCfgParsLiveData().postValue(new ConfigParsCom(CollectionsKt__CollectionsKt.emptyList(), failureBean.getErrorDesc()));
                        }
                    });
                }
            });
