...
public class CrashDumperPlugin implements DumperPlugin {
    ...
    public static final String OPTION_EXIT_DEFAULT = "0";
    public static final String OPTION_KILL_DEFAULT = "9";
    public static final String OPTION_THROW_DEFAULT = "java.lang.Error";
    ...
    private void doKill(DumperContext dumperContext, Iterator<String> it) {
        ...
        try {
            ...
            start = processBuilder.command(new String[]{"/system/bin/kill", AccountManagerConstants$LOCALE.LOCALE_SEPERATOR + nextOptionalArg, String.valueOf(Process.myPid())}).redirectErrorStream(true).start();
    ...
    public static <T> Constructor<? extends T> tryGetDeclaredConstructor(Class<T> cls, Class<?>... clsArr) {
        try {
