...
public class WebSocketSession implements SimpleSession {
    ...
    public final WriteCallback mErrorForwardingWriteCallback = new WriteCallback() {
    ...
    public final ReadCallback mReadCallback = new ReadCallback() {
    ...
    public final ReadHandler mReadHandler;
    public volatile boolean mSentClose;
    public final WriteHandler mWriteHandler;
