...
public class MethodDispatcher {
    public final Iterable<ChromeDevtoolsDomain> mDomainHandlers;
    public Map<String, MethodDispatchHelper> mMethods;
    public final ObjectMapper mObjectMapper;

    public static class MethodDispatchHelper {
        public final ChromeDevtoolsDomain mInstance;
    ...
    public static java.util.Map<java.lang.String, com.facebook.stetho.inspector.MethodDispatcher.MethodDispatchHelper> buildDispatchTable(com.facebook.stetho.json.ObjectMapper r10, java.lang.Iterable<com.facebook.stetho.inspector.protocol.ChromeDevtoolsDomain> r11) {
        /*
    ...
    public static boolean isDevtoolsMethod(Method method) {
        if (!method.isAnnotationPresent(ChromeDevtoolsMethod.class)) {
            return false;
        }
        Class[] parameterTypes = method.getParameterTypes();
        String str = method.getDeclaringClass().getSimpleName() + MAPCookie.DOT + method.getName();
