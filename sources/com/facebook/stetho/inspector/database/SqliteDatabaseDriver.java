...
public class SqliteDatabaseDriver extends DatabaseDriver2<SqliteDatabaseDescriptor> {
    ...
    public final DatabaseConnectionProvider mDatabaseConnectionProvider;
    public final DatabaseFilesProvider mDatabaseFilesProvider;
    ...
    private SQLiteDatabase openDatabase(SqliteDatabaseDescriptor sqliteDatabaseDescriptor) {
