...
public class DatabaseDriver2Adapter extends DatabaseDriver2<StringDatabaseDescriptor> {
    public final Database.DatabaseDriver mLegacy;
    ...
    public Database.ExecuteSQLResponse executeSQL(StringDatabaseDescriptor stringDatabaseDescriptor, String str, BaseDatabaseDriver.ExecuteResultHandler executeResultHandler) {
