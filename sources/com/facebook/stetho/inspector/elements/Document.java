...
public final class Document extends ThreadBoundProxy {
    ...
    public final Queue<Object> mCachedUpdateQueue = new ArrayDeque();
    ...
    public int mReferenceCounter = 0;
    ...
    public class UpdateListenerCollection implements UpdateListener {
        public final List<UpdateListener> mListeners = new ArrayList();
    ...
    private void applyDocumentUpdate(final ShadowDocument.Update update) {
        ...
        update.getChangedElements(new Accumulator<Object>() {
            public Accumulator<Object> insertedElements = new Accumulator<Object>() {
                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C39035.this.listenerInsertedElements.add(obj);
                    }
                }
            };
            ...
            while (!this.mCachedUpdateQueue.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    if (obj != null) {
                        ...
                        LogUtil.m9806e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
    ...
    public void updateTree() {
        ...
        LogUtil.m9802d("Document.updateTree() completed in %s ms%s", objArr);
    }
