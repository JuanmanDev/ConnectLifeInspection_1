...
public abstract class DownloadingAsyncPrettyPrinterFactory implements AsyncPrettyPrinterFactory {
    ...
    public class MatchResult {
        public final PrettyPrinterDisplayType mDisplayType;
        public final String mSchemaUri;
    ...
    public static void doErrorPrint(PrintWriter printWriter, InputStream inputStream, String str) {
        printWriter.print(str + "\n" + Util.readAsUTF8(inputStream));
    }

    public static AsyncPrettyPrinter getErrorAsyncPrettyPrinter(final String str, final String str2) {
    ...
    public AsyncPrettyPrinter getInstance(String str, String str2) {
        ...
        return new AsyncPrettyPrinter() {
            ...
            public void printTo(java.io.PrintWriter r4, java.io.InputStream r5) {
                /*
                    r3 = this;
                ...
                L_0x0059:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.stetho.inspector.network.DownloadingAsyncPrettyPrinterFactory.C39191.printTo(java.io.PrintWriter, java.io.InputStream):void");
            }
        };
    }
