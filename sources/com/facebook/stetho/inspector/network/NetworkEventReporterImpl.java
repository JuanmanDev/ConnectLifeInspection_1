...
public class NetworkEventReporterImpl implements NetworkEventReporter {
    public static NetworkEventReporter sInstance;
    public final AtomicInteger mNextRequestId = new AtomicInteger(0);
    public ResourceTypeHelper mResourceTypeHelper;

    public static Network.WebSocketFrame convertFrame(NetworkEventReporter.InspectorWebSocketFrame inspectorWebSocketFrame) {
    ...
    public void requestWillBeSent(NetworkEventReporter.InspectorRequest inspectorRequest) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            requestWillBeSentParams.requestId = inspectorRequest.mo23015id();
    ...
    public void webSocketWillSendHandshakeRequest(NetworkEventReporter.InspectorWebSocketRequest inspectorWebSocketRequest) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            webSocketWillSendHandshakeRequestParams.requestId = inspectorWebSocketRequest.mo23015id();
