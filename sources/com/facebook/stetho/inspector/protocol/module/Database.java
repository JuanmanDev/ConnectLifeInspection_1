...
public class Database implements ChromeDevtoolsDomain {
    public static final int MAX_BLOB_LENGTH = 512;
    public static final int MAX_EXECUTE_RESULTS = 250;
    public static final String UNKNOWN_BLOB_LABEL = "{blob}";
    public final ChromePeerManager mChromePeerManager = new ChromePeerManager();
    public List<DatabaseDriver2> mDatabaseDrivers = new ArrayList();
    public final ObjectMapper mObjectMapper;
    public final DatabasePeerRegistrationListener mPeerListener;
    ...
    public static class DatabasePeerRegistrationListener extends PeersRegisteredListener {
        public final List<DatabaseDriver2> mDatabaseDrivers;
        public final SparseArray<DatabaseDescriptorHolder> mDatabaseHolders;
        public final ObjectIdMapper mDatabaseIdMapper;
        ...
        public synchronized void onPeerAdded(JsonRpcPeer jsonRpcPeer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                databaseObject.f7193id = String.valueOf(keyAt);
        ...
        public DatabasePeerRegistrationListener(List<DatabaseDriver2> list) {
    ...
    public JsonRpcResult executeSQL(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        try {
            ...
            LogUtil.m9808e(e, "Exception executing: %s", executeSQLRequest.query);
