...
public class Page implements ChromeDevtoolsDomain {
    ...
    public static FrameResourceTree createSimpleFrameResourceTree(String str, String str2, String str3, String str4) {
        ...
        frame.mimeType = AssetHelper.DEFAULT_MIME_TYPE;
    ...
    private void notifyExecutionContexts(JsonRpcPeer jsonRpcPeer) {
        ...
        executionContextDescription.f7194id = 1;
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree("1", (String) null, ChromeDiscoveryHandler.USER_AGENT, it.hasNext() ? it.next() : "");
