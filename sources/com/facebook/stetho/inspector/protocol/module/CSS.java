...
public class CSS implements ChromeDevtoolsDomain {
        ...
        this.mDocument.postAndWait((Runnable) new Runnable() {
            public void run() {
                ...
                if (elementForNodeId == null) {
                    LogUtil.m9805e("Tried to get the style of an element that does not exist, using nodeid=" + getComputedStyleForNodeRequest.nodeId);
                    return;
                }
    ...
    public JsonRpcResult getMatchedStylesForNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        this.mDocument.postAndWait((Runnable) new Runnable() {
            public void run() {
                ...
                if (elementForNodeId == null) {
                    LogUtil.m9817w("Failed to get style of an element that does not exist, nodeid=" + getMatchedStylesForNodeRequest.nodeId);
                    return;
                }
    ...
    public SetPropertyTextResult setPropertyText(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (str4 == null || !str4.contains(RunnerArgs.CLASSPATH_SEPARATOR)) {
            str2 = null;
            str = null;
        } else {
            String[] split2 = setPropertyTextRequest.text.split(RunnerArgs.CLASSPATH_SEPARATOR, 2);
        ...
        this.mDocument.postAndWait((Runnable) new Runnable() {
            public void run() {
                ...
                if (elementForNodeId == null) {
                    LogUtil.m9817w("Failed to get style of an element that does not exist, nodeid=" + parseInt);
                    return;
                }
                if (str2 != null) {
