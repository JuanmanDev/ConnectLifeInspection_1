...
public class JsonRpcPeer {
    public final DisconnectObservable mDisconnectObservable = new DisconnectObservable();
    public long mNextRequestId;
    public final ObjectMapper mObjectMapper;
    public final SimpleSession mPeer;
    public final Map<Long, PendingRequest> mPendingRequests = new HashMap();
    ...
    public void invokeMethod(String str, Object obj, PendingRequestCallback pendingRequestCallback) {
