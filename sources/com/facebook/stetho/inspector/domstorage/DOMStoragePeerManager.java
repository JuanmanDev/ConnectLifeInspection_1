...
public class DOMStoragePeerManager extends ChromePeerManager {
    ...
    public final PeerRegistrationListener mPeerListener;

    public class DevToolsSharedPreferencesListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        public final Map<String, Object> mCopy;
        public final SharedPreferences mPrefs;
        public final DOMStorage.StorageId mStorageId;
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str) {
            ...
            if (containsKey && containsKey2) {
                ...
                LogUtil.m9810i("Detected rapid put/remove of %s", str);
            }
        }
    ...
    public DOMStoragePeerManager(Context context) {
        C38981 r0 = new PeersRegisteredListener() {
            public final List<DevToolsSharedPreferencesListener> mPrefsListeners = new ArrayList();
