...
public class Stetho {
    ...
    public static class BuilderBasedInitializer extends Initializer {
        public final DumperPluginsProvider mDumperPlugins;
        public final InspectorModulesProvider mInspectorModules;
        ...
        public BuilderBasedInitializer(InitializerBuilder initializerBuilder) {
    ...
    public static final class DefaultDumperPluginsBuilder {
        ...
        public final PluginBuilder<DumperPlugin> mDelegate = new PluginBuilder<>();
    ...
    public static final class DefaultInspectorModulesBuilder {
        ...
        public List<DatabaseDriver2> mDatabaseDrivers;
        public DatabaseFilesProvider mDatabaseFilesProvider;
        public final PluginBuilder<ChromeDevtoolsDomain> mDelegate = new PluginBuilder<>();
        public DocumentProviderFactory mDocumentProvider;
        public boolean mExcludeSqliteDatabaseDriver;
        public RuntimeReplFactory mRuntimeRepl;
    ...
    public static class PluginBuilder<T> {
        ...
        public final ArrayList<T> mPlugins;
        public final Set<String> mProvidedNames;
        public final Set<String> mRemovedNames;
    ...
    public static void initialize(Initializer initializer) {
        if (!ActivityTracker.get().beginTrackingIfPossible((Application) initializer.mContext.getApplicationContext())) {
            LogUtil.m9817w("Automatic activity tracking not available on this API level, caller must invoke ActivityTracker methods manually!");
        }
        initializer.start();
    }
