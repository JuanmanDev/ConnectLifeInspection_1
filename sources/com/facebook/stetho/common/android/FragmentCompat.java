...
public abstract class FragmentCompat<FRAGMENT, DIALOG_FRAGMENT, FRAGMENT_MANAGER, FRAGMENT_ACTIVITY extends Activity> {
    public static FragmentCompat sFrameworkInstance;
    public static final boolean sHasSupportFragment = (ReflectionUtil.tryGetClassForName("androidx.fragment.app.Fragment") != null);
    public static FragmentCompat sSupportInstance;
