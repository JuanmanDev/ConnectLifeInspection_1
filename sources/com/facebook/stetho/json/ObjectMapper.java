...
public class ObjectMapper {
    public final Map<Class<?>, Method> mJsonValueMethodCache = new IdentityHashMap();
    ...
    private Enum getEnumByMethod(String str, Class<? extends Enum> cls, Method method) {
        ...
        throw new IllegalArgumentException("No enum constant " + cls.getName() + MAPCookie.DOT + str);
    }
    ...
    public static Method getJsonValueMethodImpl(Class<?> cls) {
    ...
    public static boolean isWrapperOrPrimitiveType(Class<?> cls) {
