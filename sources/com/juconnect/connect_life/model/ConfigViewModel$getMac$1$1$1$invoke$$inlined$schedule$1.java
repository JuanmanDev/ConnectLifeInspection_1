...
public final class ConfigViewModel$getMac$1$1$1$invoke$$inlined$schedule$1 extends TimerTask {
    public final /* synthetic */ ConfigViewModel this$0;

    public ConfigViewModel$getMac$1$1$1$invoke$$inlined$schedule$1(ConfigViewModel configViewModel) {
        this.this$0 = configViewModel;
    }

    public void run() {
        this.this$0.writeLog("配网", "获取到mac地址成功");
    }
}
