...
@DebugMetadata(mo48700c = "com.juconnect.connect_life.model.ConfigViewModel$getMac$1", mo48701f = "ConfigViewModel.kt", mo48702i = {}, mo48703l = {}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
                ...
                public final void invoke(@NotNull HiSmartCallback<ConfigParsCom> hiSmartCallback) {
                    ...
                    hiSmartCallback.success(new Function1<ConfigParsCom, Unit>() {
                        ...
                        public final void invoke(@NotNull ConfigParsCom configParsCom) {
                            ...
                            new Timer().schedule(new ConfigViewModel$getMac$1$1$1$invoke$$inlined$schedule$1(configViewModel), PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS);
                    ...
                    hiSmartCallback.failure(new Function1<FailureBean, Unit>() {
                        ...
                        public final void invoke(@NotNull FailureBean failureBean) {
                            ...
                            new Timer().schedule(new ConfigViewModel$getMac$1$1$2$invoke$$inlined$schedule$1(configViewModel2, failureBean), PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS);
