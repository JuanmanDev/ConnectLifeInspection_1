...
public final class ConfigViewModel$getMac$1$1$2$invoke$$inlined$schedule$1 extends TimerTask {
    public final /* synthetic */ FailureBean $it$inlined;
    public final /* synthetic */ ConfigViewModel this$0;

    public ConfigViewModel$getMac$1$1$2$invoke$$inlined$schedule$1(ConfigViewModel configViewModel, FailureBean failureBean) {
        this.this$0 = configViewModel;
        this.$it$inlined = failureBean;
    }

    public void run() {
        this.this$0.writeLog("配网", Intrinsics.stringPlus("获取mac地址失败：", this.$it$inlined.getErrorDesc()));
    }
}
