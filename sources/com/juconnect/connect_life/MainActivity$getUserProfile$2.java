...
public final class MainActivity$getUserProfile$2 extends Lambda implements Function1<Throwable, Unit> {
    public static final MainActivity$getUserProfile$2 INSTANCE = new MainActivity$getUserProfile$2();

    public MainActivity$getUserProfile$2() {
        super(1);
    }
