...
public final class MainActivity$getUserProfile$1 extends Lambda implements Function1<UserProfile, Unit> {
    public static final MainActivity$getUserProfile$1 INSTANCE = new MainActivity$getUserProfile$1();

    public MainActivity$getUserProfile$1() {
        super(1);
    }
    ...
    public final void invoke(@Nullable UserProfile userProfile) {
        ...
        if (methodChannel != null) {
            methodChannel.mo46573c(AccountMethodConstant.METHOD_GET_USER_PROFILE_CALLBACK, j);
        }
    }
}
