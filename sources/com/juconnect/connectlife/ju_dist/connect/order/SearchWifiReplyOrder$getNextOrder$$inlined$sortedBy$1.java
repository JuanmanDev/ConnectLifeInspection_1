...
public final class SearchWifiReplyOrder$getNextOrder$$inlined$sortedBy$1<T> implements Comparator {
    public final int compare(T t, T t2) {
        return ComparisonsKt__ComparisonsKt.compareValues(((WiFiArr) t).getRSSI(), ((WiFiArr) t2).getRSSI());
    }
}
