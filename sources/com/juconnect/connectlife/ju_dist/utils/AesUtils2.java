...
@Metadata(mo47990d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0007\b\u0016¢\u0006\u0002\u0010\u0002J\"\u0010\n\u001a\u0004\u0018\u00010\u00042\b\u0010\u000b\u001a\u0004\u0018\u00010\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000eJ\u0010\u0010\u0010\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u000b\u001a\u00020\u0004J\b\u0010\u0011\u001a\u00020\tH\u0002J\u0010\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0015H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X.¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX.¢\u0006\u0002\n\u0000¨\u0006\u0016"}, mo47991d2 = {"Lcom/juconnect/connectlife/ju_dist/utils/AesUtils2;", "", "()V", "TAG", "", "ivParameterSpec", "Ljavax/crypto/spec/IvParameterSpec;", "password", "secretKeySpec", "Ljavax/crypto/spec/SecretKeySpec;", "decrypt", "content", "", "offset", "", "length", "encrypt", "initSecretKeySpec", "throwException", "", "e", "Ljava/lang/Exception;", "ju_dist_release"}, mo47992k = 1, mo47993mv = {1, 6, 0}, mo47995xi = 48)
...
public final class AesUtils2 {
    ...
    public final String decrypt(@Nullable byte[] bArr, int i, int i2) {
        try {
            ...
            companion.debug(str, Intrinsics.stringPlus("base解析的数据:", new String(decode, Charsets.UTF_8)));
            byte[] bytes = this.password.getBytes(Charsets.UTF_8);
            Intrinsics.checkNotNullExpressionValue(bytes, "this as java.lang.String).getBytes(charset)");
            ...
            companion2.debug(str2, Intrinsics.stringPlus("明文的数据:", new String(doFinal, Charsets.UTF_8)));
    ...
    public final String encrypt(@NotNull String str) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.Companion.debug(this.TAG, Intrinsics.stringPlus("加密失败:", e.getMessage()));
            throwException(e);
            return null;
        } catch (NoSuchAlgorithmException e2) {
            e2.printStackTrace();
            LogUtils.Companion.debug(this.TAG, Intrinsics.stringPlus("加密失败:", e2.getMessage()));
            throwException(e2);
            return null;
        } catch (UnsupportedEncodingException e3) {
            e3.printStackTrace();
            LogUtils.Companion.debug(this.TAG, Intrinsics.stringPlus("加密失败:", e3.getMessage()));
            throwException(e3);
            return null;
        } catch (InvalidKeyException e4) {
            e4.printStackTrace();
            LogUtils.Companion.debug(this.TAG, Intrinsics.stringPlus("加密失败:", e4.getMessage()));
            throwException(e4);
            return null;
        } catch (IllegalBlockSizeException e5) {
            e5.printStackTrace();
            LogUtils.Companion.debug(this.TAG, Intrinsics.stringPlus("加密失败:", e5.getMessage()));
            throwException(e5);
            return null;
        } catch (BadPaddingException e6) {
            e6.printStackTrace();
            LogUtils.Companion.debug(this.TAG, Intrinsics.stringPlus("加密失败:", e6.getMessage()));
            throwException(e6);
            return null;
        }
    }
