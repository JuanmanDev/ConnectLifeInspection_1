...
public final class RunSuspend implements Continuation<Unit> {
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m27308unboximpl());
                }
            }
        }
    }
    ...
    public final Result<Unit> m28506getResultxLWZpok() {
        return this.result;
    }

    public void resumeWith(@NotNull Object obj) {
        synchronized (this) {
            this.result = Result.m27298boximpl(obj);
            Intrinsics.checkNotNull(this, "null cannot be cast to non-null type java.lang.Object");
            notifyAll();
