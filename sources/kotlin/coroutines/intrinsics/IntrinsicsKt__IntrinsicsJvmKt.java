...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt(Continuation<? super T> continuation, Function1<? super Continuation<? super T>, ? extends Object> function1) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            return new C9498x96e8297a(continuation, function1);
        }
        return new C9499x96e8297b(continuation, context, function1);
    }
    ...
    public static final <T> Continuation<Unit> createCoroutineUnintercepted(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            return new C9494xa50de660(probeCoroutineCreated, function1);
        }
        return new C9495xa50de661(probeCoroutineCreated, context, function1);
    }
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnintercepted(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, @NotNull Continuation<? super T> continuation) {
        ...
        CoroutineContext context = probeCoroutineCreated.getContext();
        if (context == EmptyCoroutineContext.INSTANCE) {
            return new C9496xa50de662(probeCoroutineCreated, function2, r);
        }
        return new C9497xa50de663(probeCoroutineCreated, context, function2, r);
    }
}
