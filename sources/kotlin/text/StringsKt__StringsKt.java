...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
                ...
                if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                    while (true) {
                        ...
                        if (str2 == null) {
                            ...
                            return TuplesKt.m25743to(Integer.valueOf(first), str2);
                        }
                    }
                }
            } else {
                ...
                if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                    while (true) {
                        ...
                        if (str4 == null) {
                            ...
                            return TuplesKt.m25743to(Integer.valueOf(first2), str4);
                        }
                    }
                }
            }
        ...
        return TuplesKt.m25743to(Integer.valueOf(indexOf$default), str5);
    }
    ...
    public static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, String[] strArr, int i, boolean z, int i2) {
        requireNonNegativeLimit(i2);
        return new DelimitedRangesSequence(charSequence, i, i2, new StringsKt__StringsKt$rangesDelimitedBy$2(ArraysKt___ArraysJvmKt.asList((T[]) strArr), z));
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, int i, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        if (!z && (charSequence instanceof String) && (charSequence2 instanceof String)) {
            return StringsKt__StringsJVMKt.startsWith$default((String) charSequence, (String) charSequence2, i, false, 4, (Object) null);
        }
