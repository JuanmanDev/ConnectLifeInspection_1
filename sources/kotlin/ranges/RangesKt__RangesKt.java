...
public class RangesKt__RangesKt {
    ...
    @InlineOnly
    public static final <T, R extends Iterable<? extends T> & ClosedRange<T>> boolean contains(R r, T t) {
