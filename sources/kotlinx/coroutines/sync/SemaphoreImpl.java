...
@Metadata(mo47990d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u000b\n\u0002\u0018\u0002\n\u0002\u0010\u0003\n\u0002\b\u0004\n\u0002\u0018\u0002\b\u0002\u0018\u00002\u00020\u001eB\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0001\u0012\u0006\u0010\u0003\u001a\u00020\u0001¢\u0006\u0004\b\u0004\u0010\u0005J\u0013\u0010\u0007\u001a\u00020\u0006H@ø\u0001\u0000¢\u0006\u0004\b\u0007\u0010\bJ\u0013\u0010\t\u001a\u00020\u0006H@ø\u0001\u0000¢\u0006\u0004\b\t\u0010\bJ\u001d\u0010\r\u001a\u00020\f2\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00060\nH\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0011\u001a\u00020\fH\u0016¢\u0006\u0004\b\u0011\u0010\u0012J\u000f\u0010\u0013\u001a\u00020\fH\u0002¢\u0006\u0004\b\u0013\u0010\u0012J\u0019\u0010\u0014\u001a\u00020\f*\b\u0012\u0004\u0012\u00020\u00060\nH\u0002¢\u0006\u0004\b\u0014\u0010\u000eR\u0014\u0010\u0017\u001a\u00020\u00018VX\u0004¢\u0006\u0006\u001a\u0004\b\u0015\u0010\u0016R \u0010\u001a\u001a\u000e\u0012\u0004\u0012\u00020\u0019\u0012\u0004\u0012\u00020\u00060\u00188\u0002X\u0004¢\u0006\u0006\n\u0004\b\u001a\u0010\u001bR\u0014\u0010\u0002\u001a\u00020\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0002\u0010\u001c\u0002\u0004\n\u0002\b\u0019¨\u0006\u001d"}, mo47991d2 = {"Lkotlinx/coroutines/sync/SemaphoreImpl;", "", "permits", "acquiredPermits", "<init>", "(II)V", "", "acquire", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "acquireSlowPath", "Lkotlinx/coroutines/CancellableContinuation;", "cont", "", "addAcquireToQueue", "(Lkotlinx/coroutines/CancellableContinuation;)Z", "release", "()V", "tryAcquire", "()Z", "tryResumeNextFromQueue", "tryResumeAcquire", "getAvailablePermits", "()I", "availablePermits", "Lkotlin/Function1;", "", "onCancellationRelease", "Lkotlin/jvm/functions/Function1;", "I", "kotlinx-coroutines-core", "Lkotlinx/coroutines/sync/Semaphore;"}, mo47992k = 1, mo47993mv = {1, 6, 0}, mo47995xi = 48)
/* compiled from: Semaphore.kt */
public final class SemaphoreImpl implements Semaphore {
    public static final /* synthetic */ AtomicIntegerFieldUpdater _availablePermits$FU;
    public static final /* synthetic */ AtomicLongFieldUpdater deqIdx$FU;
    public static final /* synthetic */ AtomicLongFieldUpdater enqIdx$FU;
    public static final /* synthetic */ AtomicReferenceFieldUpdater head$FU;
    public static final /* synthetic */ AtomicReferenceFieldUpdater tail$FU;
    @NotNull
    ...
    static {
        ...
        deqIdx$FU = AtomicLongFieldUpdater.newUpdater(cls2, "deqIdx");
        tail$FU = AtomicReferenceFieldUpdater.newUpdater(cls2, cls, "tail");
        enqIdx$FU = AtomicLongFieldUpdater.newUpdater(cls2, "enqIdx");
        _availablePermits$FU = AtomicIntegerFieldUpdater.newUpdater(cls2, "_availablePermits");
    }
    ...
    public SemaphoreImpl(int i, int i2) {
        ...
        boolean z = true;
        if (this.permits > 0) {
            if ((i2 < 0 || i2 > this.permits) ? false : z) {
    ...
    public final boolean addAcquireToQueue(kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit> r15) {
        ...
        L_0x0012:
            ...
            goto L_0x0026
        L_0x0021:
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m28840constructorimpl(r5)
            goto L_0x0038
        L_0x0026:
            java.lang.Object r6 = r5.getNextOrClosed()
            ...
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m28840constructorimpl(r5)
        L_0x0038:
            boolean r6 = kotlinx.coroutines.internal.SegmentOrClosed.m28845isClosedimpl(r5)
            r7 = 0
            r8 = 1
            if (r6 != 0) goto L_0x007d
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m28843getSegmentimpl(r5)
        L_0x0044:
        ...
        L_0x0073:
            ...
            goto L_0x0044
        L_0x007d:
            kotlinx.coroutines.internal.Segment r0 = kotlinx.coroutines.internal.SegmentOrClosed.m28843getSegmentimpl(r5)
            kotlinx.coroutines.sync.SemaphoreSegment r0 = (kotlinx.coroutines.sync.SemaphoreSegment) r0
            int r3 = kotlinx.coroutines.sync.SemaphoreKt.SEGMENT_SIZE
            long r3 = (long) r3
            long r1 = r1 % r3
    ...
    public Object acquire(@NotNull Continuation<? super Unit> continuation) {
        ...
        return acquireSlowPath == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? acquireSlowPath : Unit.INSTANCE;
    }
