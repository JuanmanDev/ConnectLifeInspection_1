...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m27299constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m27299constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m27302exceptionOrNullimpl(obj) != null) {
            obj = baseContinuationImplClass;
        }
        baseContinuationImplClassName = (String) obj;
        try {
            Result.Companion companion3 = Result.Companion;
            obj2 = Result.m27299constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m27299constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m27302exceptionOrNullimpl(obj2) != null) {
    ...
    public static final <E extends Throwable> Pair<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause == null || !Intrinsics.areEqual((Object) cause.getClass(), (Object) e.getClass())) {
            return TuplesKt.m25743to(e, new StackTraceElement[0]);
        }
        ...
        if (z) {
            return TuplesKt.m25743to(cause, stackTrace);
        }
        return TuplesKt.m25743to(e, new StackTraceElement[0]);
    }
