...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> cls) {
        ...
        for (Constructor createSafeConstructor : ArraysKt___ArraysKt.sortedWith((T[]) cls.getConstructors(), new C9592x1af7bbab())) {
    ...
    public static final Function1<Throwable, Throwable> createSafeConstructor(Constructor<?> constructor) {
        ...
        if (length == 0) {
            return new C9596x18164156(constructor);
        }
        if (length == 1) {
            Class cls2 = parameterTypes[0];
            if (Intrinsics.areEqual((Object) cls2, (Object) Throwable.class)) {
                return new C9594x18164154(constructor);
            }
            if (Intrinsics.areEqual((Object) cls2, (Object) cls)) {
                return new C9595x18164155(constructor);
            }
            return null;
            ...
            return new C9593x18164153(constructor);
        } else {
            return null;
        }
    }
    ...
    public static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            ...
            num = Result.m27299constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, (Object) null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m27299constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(i);
        if (Result.m27305isFailureimpl(num)) {
            num = valueOf;
        }
    ...
    public static final <E extends Throwable> E tryCopyException(@NotNull E e) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            e2 = Result.m27299constructorimpl(((CopyableThrowable) e).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            e2 = Result.m27299constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m27305isFailureimpl(e2)) {
            e2 = null;
        }
        return (Throwable) e2;
    }
