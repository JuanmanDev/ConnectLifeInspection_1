...
public final class C9596x18164156 extends Lambda implements Function1<Throwable, Throwable> {
    public final /* synthetic */ Constructor $constructor$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C9596x18164156(Constructor constructor) {
        super(1);
    ...
    public final Throwable invoke(@NotNull Throwable th) {
        ...
        try {
            ...
            if (newInstance != null) {
                ...
                th2.initCause(th);
                obj = Result.m27299constructorimpl(th2);
            ...
            obj = Result.m27299constructorimpl(ResultKt.createFailure(th3));
        }
    }
}
