...
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(@NotNull Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m27299constructorimpl(ResultKt.createFailure(closed.getSendException())));
    }
