...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m28804isSuccessimpl(r0)) {
                return true;
            }
            Throwable r02 = ChannelResult.m28798exceptionOrNullimpl(r0);
            if (r02 == null) {
                return false;
            }
    ...
    Object m28816trySendJP2dKIU(E e);
}
