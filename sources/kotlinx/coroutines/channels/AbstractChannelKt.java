...
public final class AbstractChannelKt {
    ...
    public static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m28807closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m28809successJP2dKIU(obj);
    }

    public static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m28807closedJP2dKIU(closed.closeCause);
    }
}
