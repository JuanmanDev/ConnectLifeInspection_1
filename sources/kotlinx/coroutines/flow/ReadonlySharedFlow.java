...
public final class ReadonlySharedFlow<T> implements SharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public ReadonlySharedFlow(@NotNull SharedFlow<? extends T> sharedFlow, @Nullable Job job2) {
        this.job = job2;
