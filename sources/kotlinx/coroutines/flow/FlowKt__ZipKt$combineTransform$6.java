...
@DebugMetadata(mo48700c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo48701f = "Zip.kt", mo48702i = {}, mo48703l = {251}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo48700c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo48701f = "Zip.kt", mo48702i = {}, mo48703l = {251}, mo48704m = "invokeSuspend", mo48705n = {}, mo48706s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C95772 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        public /* synthetic */ Object L$0;
        ...
        public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, @NotNull T[] tArr, @Nullable Continuation<? super Unit> continuation) {
            C95772 r0 = new C95772(r3, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            C95772 r4 = new C95772((Continuation<? super C95772>) null);
            this.label = 1;
    ...
    public final Object invokeSuspend$$forInline(@NotNull Object obj) {
        ...
        Intrinsics.needClassReification();
        final Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> function3 = this.$transform;
        C95772 r2 = new C95772((Continuation<? super C95772>) null);
        InlineMarker.mark(0);
