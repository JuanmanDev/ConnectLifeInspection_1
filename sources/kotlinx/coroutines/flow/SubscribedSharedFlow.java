...
public final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    public SubscribedSharedFlow(@NotNull SharedFlow<? extends T> sharedFlow2, @NotNull Function2<? super FlowCollector<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
