...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m28821debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m28776toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m28822sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m28776toDelayMillisLRDsOJo(j));
    }
