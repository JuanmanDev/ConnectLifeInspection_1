...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m27299constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
    ...
    public static final void postFrameCallback(Choreographer choreographer2, CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new C9490b(cancellableContinuation));
    }

    /* renamed from: postFrameCallback$lambda-6  reason: not valid java name */
    public static final void m28781postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
