...
public final class TimeoutKt {
    ...
    public static final <T> Object m28778withTimeoutKLykuaI(long j, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m28776toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L_0x0018:
            ...
            kotlin.ResultKt.throwOnFailure(r10)     // Catch:{ TimeoutCancellationException -> 0x0034 }
            goto L_0x006d
        L_0x0034:
            r8 = move-exception
            goto L_0x0070
        ...
        L_0x0048:
            ...
            r10.<init>()
            r0.L$0 = r9     // Catch:{ TimeoutCancellationException -> 0x006e }
            r0.L$1 = r10     // Catch:{ TimeoutCancellationException -> 0x006e }
            r0.J$0 = r7     // Catch:{ TimeoutCancellationException -> 0x006e }
            r0.label = r4     // Catch:{ TimeoutCancellationException -> 0x006e }
            kotlinx.coroutines.TimeoutCoroutine r2 = new kotlinx.coroutines.TimeoutCoroutine     // Catch:{ TimeoutCancellationException -> 0x006e }
            r2.<init>(r7, r0)     // Catch:{ TimeoutCancellationException -> 0x006e }
            r10.element = r2     // Catch:{ TimeoutCancellationException -> 0x006e }
            java.lang.Object r7 = setupTimeout(r2, r9)     // Catch:{ TimeoutCancellationException -> 0x006e }
            java.lang.Object r8 = kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch:{ TimeoutCancellationException -> 0x006e }
    ...
    public static final <T> Object m28779withTimeoutOrNullKLykuaI(long j, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m28776toDelayMillisLRDsOJo(j), function2, continuation);
    }
}
