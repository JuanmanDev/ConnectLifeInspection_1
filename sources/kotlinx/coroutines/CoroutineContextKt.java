...
public final class CoroutineContextKt {
    ...
    public static final String getCoroutineName(@NotNull CoroutineContext coroutineContext) {
        ...
        return str + RunnerArgs.METHOD_SEPARATOR + coroutineId.getId();
    }
