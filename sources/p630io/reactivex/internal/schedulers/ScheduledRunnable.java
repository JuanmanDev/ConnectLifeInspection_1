...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Runnable, Callable<Object>, C9207b {
    ...
    public ScheduledRunnable(Runnable runnable, C9220a aVar) {
        super(3);
    ...
    public void dispose() {
        ...
        L_0x0044:
            ...
            if (r1 == 0) goto L_0x0035
            f.c.s.a.a r0 = (p553f.p594c.p602s.p603a.C9220a) r0
            r0.mo47028c(r5)
        L_0x004f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p630io.reactivex.internal.schedulers.ScheduledRunnable.dispose():void");
    }
