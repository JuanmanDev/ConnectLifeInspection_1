...
public final class BoundedSubscriber<T> extends AtomicReference<C9803c> implements C9186d<T>, C9803c, C9207b {
    ...
    public BoundedSubscriber(C9217e<? super T> eVar, C9217e<? super Throwable> eVar2, C9213a aVar, C9217e<? super C9803c> eVar3, int i) {
        this.onNext = eVar;
        this.onError = eVar2;
    ...
    public void onNext(T t) {
        if (!isDisposed()) {
            try {
                ...
                if (i == this.limit) {
                    this.consumed = 0;
                    ((C9803c) get()).request((long) this.limit);
                    return;
                }
                this.consumed = i;
            } catch (Throwable th) {
