...
/* renamed from: c.q.a.c.i.b.m */
/* compiled from: com.google.android.gms:play-services-measurement-impl@@21.2.0 */
public final class C5559m {
    ...
    public static void m15889a(p040c.p200q.p201a.p264c.p340i.p342b.C5515i3 r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x0031:
            ...
            r1 = r13
        L_0x0033:
            c.q.a.c.i.b.g3 r2 = r14.mo28344w()     // Catch:{ all -> 0x00e2 }
            java.lang.String r3 = "Error querying for table"
            r2.mo28261c(r3, r10, r0)     // Catch:{ all -> 0x00e2 }
        ...
        L_0x00bc:
            ...
            c.q.a.c.i.b.g3 r1 = r14.mo28344w()     // Catch:{ SQLiteException -> 0x00d7 }
            ...
            r1.mo28261c(r2, r10, r0)     // Catch:{ SQLiteException -> 0x00d7 }
        L_0x00d1:
            return
        L_0x00d2:
            r0 = move-exception
        ...
        L_0x00d7:
            r0 = move-exception
            c.q.a.c.i.b.g3 r1 = r14.mo28339r()
        ...
        L_0x00ea:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p040c.p200q.p201a.p264c.p340i.p342b.C5559m.m15889a(c.q.a.c.i.b.i3, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    /* renamed from: b */
    public static void m15890b(C5515i3 i3Var, SQLiteDatabase sQLiteDatabase) {
        if (i3Var != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                i3Var.mo28344w().mo28259a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                i3Var.mo28344w().mo28259a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                i3Var.mo28344w().mo28259a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                i3Var.mo28344w().mo28259a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
