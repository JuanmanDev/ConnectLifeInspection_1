...
/* renamed from: c.q.a.c.g.g.hk */
/* compiled from: com.google.firebase:firebase-auth@@21.1.0 */
public final class C4482hk {

    /* renamed from: a */
    public static final int[] f9276a = {0, 3, 6, 9, 12, 16, 19, 22, 25, 28};

    /* renamed from: b */
    public static final int[] f9277b = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};

    /* renamed from: c */
    public static final int[] f9278c = {67108863, 33554431};

    /* renamed from: d */
    public static final int[] f9279d = {26, 25};

    /* renamed from: a */
    public static void m12109a(long[] jArr, long[] jArr2, long[] jArr3) {
        long[] jArr4 = new long[19];
        m12110b(jArr4, jArr2, jArr3);
        m12111c(jArr4, jArr);
    }
    ...
    public static void m12110b(long[] r18, long[] r19, long[] r20) {
        /*
            r0 = 0
            r1 = r19[r0]
            r3 = r20[r0]
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p040c.p200q.p201a.p264c.p294g.p333g.C4482hk.m12110b(long[], long[], long[]):void");
    }

    /* renamed from: c */
    public static void m12111c(long[] jArr, long[] jArr2) {
        m12113e(jArr);
        m12112d(jArr);
    ...
    /* renamed from: d */
    public static void m12112d(long[] jArr) {
        jArr[10] = 0;
        int i = 0;
        while (i < 10) {
            long j = jArr[i];
    ...
    /* renamed from: e */
    public static void m12113e(long[] jArr) {
    ...
    /* renamed from: f */
    public static void m12114f(long[] jArr, long[] jArr2, long j) {
        for (int i = 0; i < 10; i++) {
            jArr[i] = jArr2[i] * j;
        }
    }
    ...
    /* renamed from: g */
    public static void m12115g(long[] jArr, long[] jArr2) {
        long j = jArr2[0];
        long j2 = jArr2[0];
        long j3 = jArr2[1];
        ...
        long j48 = jArr2[8];
        long j49 = jArr2[9];
        m12111c(new long[]{j * j, (j2 + j2) * jArr2[1], j4 + j4, j5 + j5, (j6 * j6) + (j7 * 4 * j8) + ((j9 + j9) * jArr2[4]), j10 + j10, j17 + j17, j18 + j18, (j19 * j19) + j25 + j25, j26 + j26, j33 + j33, j34 + j34, (j35 * j35) + j39 + j39, j40 + j40, j45 + j45, j46 + j46, (j47 * j47) + (jArr2[7] * 4 * jArr2[9]), (j48 + j48) * jArr2[9], (j49 + j49) * j49}, jArr);
    }

    /* renamed from: h */
    public static void m12116h(long[] jArr, long[] jArr2, long[] jArr3) {
        for (int i = 0; i < 10; i++) {
    ...
    /* renamed from: i */
    public static void m12117i(long[] jArr, long[] jArr2, long[] jArr3) {
        for (int i = 0; i < 10; i++) {
            jArr[i] = jArr2[i] + jArr3[i];
        }
    }
    ...
    /* renamed from: j */
    public static byte[] m12118j(long[] jArr) {
        ...
        for (int i12 = 1; i12 < 10; i12++) {
            int i13 = ~(((int) copyOf[i12]) ^ f9278c[i12 & 1]);
            int i14 = i13 & (i13 << 16);
            int i15 = i14 & (i14 << 8);
            int i16 = i15 & (i15 << 4);
            int i17 = i16 & (i16 << 2);
        ...
        for (int i20 = 0; i20 < 10; i20++) {
            copyOf[i20] = copyOf[i20] << f9277b[i20];
        }
    ...
    /* renamed from: k */
    public static long[] m12119k(byte[] bArr) {
        long[] jArr = new long[10];
        for (int i = 0; i < 10; i++) {
            int i2 = f9276a[i];
            jArr[i] = ((((((long) (bArr[i2] & 255)) | (((long) (bArr[i2 + 1] & 255)) << 8)) | (((long) (bArr[i2 + 2] & 255)) << 16)) | (((long) (bArr[i2 + 3] & 255)) << 24)) >> f9277b[i]) & ((long) f9278c[i & 1]);
        }
        return jArr;
    }
}
