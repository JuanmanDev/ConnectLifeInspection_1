...
/* renamed from: c.q.e.l.h */
/* compiled from: GridSampler */
public abstract class C7039h {

    /* renamed from: a */
    public static C7039h f13475a = new C7036e();
    ...
    public static void m20867a(p040c.p200q.p406e.p410l.C7033b r9, float[] r10) {
        /*
            int r0 = r9.mo32542k()
            int r9 = r9.mo32538h()
            r1 = 0
        ...
        L_0x0085:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p040c.p200q.p406e.p410l.C7039h.m20867a(c.q.e.l.b, float[]):void");
    }

    /* renamed from: b */
    public static C7039h m20868b() {
        return f13475a;
    }

    /* renamed from: c */
    public abstract C7033b mo32566c(C7033b bVar, int i, int i2, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16);

    /* renamed from: d */
    public abstract C7033b mo32567d(C7033b bVar, int i, int i2, C7041j jVar);
}
