...
/* renamed from: c.q.e.l.k */
/* compiled from: StringUtils */
public final class C7042k {

    /* renamed from: a */
    public static final String f13486a;

    /* renamed from: b */
    public static final boolean f13487b;

    static {
        String name = Charset.defaultCharset().name();
        f13486a = name;
        f13487b = "SJIS".equalsIgnoreCase(name) || "EUC_JP".equalsIgnoreCase(f13486a);
    }

    /* renamed from: a */
    public static String m20882a(byte[] bArr, Map<DecodeHintType, ?> map) {
        byte[] bArr2 = bArr;
